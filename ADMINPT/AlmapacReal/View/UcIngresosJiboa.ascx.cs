using ADMINPT.AlmapacReal.Reportes;
...
{
    public partial class UcIngresosJiboa : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            UCEncabezado.Titulo = "INGRESOS DE TRASLADO";
        ...
        {
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptIngresosJBAlmapacReal(Convert.ToInt32(cbxProducto.Value), Convert.ToString(cb_zafra.Text), Convert.ToDateTime(txt_fechad.Text), Convert.ToDateTime(txt_fechah.Text)));
