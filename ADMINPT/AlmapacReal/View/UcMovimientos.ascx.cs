...
{
    public partial class UcMovimientos : System.Web.UI.UserControl
    {
        ...
        {
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMovimientosAlmapacReal(Convert.ToInt32(cbxProducto.Value), Convert.ToString(cb_zafra.Text), Convert.ToDateTime(txt_fechad.Text), Convert.ToDateTime(txt_fechah.Text)));
