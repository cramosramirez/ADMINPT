<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_DETA.ascx.cs" Inherits="ADMINPT.controles.movimiento.UcListaENTRADA_SALIDA_DETA" %>
