<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_ENCA.ascx.cs" Inherits="ADMINPT.controles.movimiento.UcListaENTRADA_SALIDA_ENCA" %>
...
<CellStyle HorizontalAlign="Center"></CellStyle>
        ...
        <dx:GridViewDataDateColumn Caption="Fecha" FieldName="FECHA" VisibleIndex="10">
...
<asp:ObjectDataSource ID="odsLista" runat="server" SelectMethod="ObtenerLista"  TypeName="ADMINPT.BL.CENTRADA_SALIDA_ENCA">    
