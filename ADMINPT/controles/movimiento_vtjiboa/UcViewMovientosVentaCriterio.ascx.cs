...
{
    public partial class UcViewMovientosVentaCriterio : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            UCEncabezado.Titulo = "VENTAS POR PRODUCTO";
        ...
        {
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMoviVentasDiariosPCriterios(Convert.ToInt32(cb_bodegaO.Value), Convert.ToDateTime(txt_fechad.Text), Convert.ToDateTime(txt_fechah.Text), Convert.ToString("13,14"), Convert.ToInt32(cbxProducto.Value)));
