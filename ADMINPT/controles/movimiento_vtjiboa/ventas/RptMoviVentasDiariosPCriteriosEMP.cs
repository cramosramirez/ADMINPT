...
{
    public partial class RptMoviVentasDiariosPCriteriosEMP : DevExpress.XtraReports.UI.XtraReport
    {
        public RptMoviVentasDiariosPCriteriosEMP(int ID_BODEGAO, DateTime FECHAD, DateTime FECHAH, string ID_CONCE, int ID_PRODUCTO)
        {
            InitializeComponent();
