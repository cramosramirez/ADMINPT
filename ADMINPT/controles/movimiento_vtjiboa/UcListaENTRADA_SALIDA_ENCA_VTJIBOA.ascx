<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_ENCA_VTJIBOA.ascx.cs" Inherits="ADMINPT.controles.movimiento_vtjiboa.UcListaENTRADA_SALIDA_ENCA_VTJIBOA" %>
