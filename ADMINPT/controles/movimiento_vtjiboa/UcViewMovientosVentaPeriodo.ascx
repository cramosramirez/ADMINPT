<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewMovientosVentaPeriodo.ascx.cs" Inherits="ADMINPT.controles.movimiento_vtjiboa.UcViewMovientosVentaPeriodo" %>
