<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewMovientosVentaCriterio.ascx.cs" Inherits="ADMINPT.controles.movimiento_vtjiboa.UcViewMovientosVentaCriterio" %>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            ...
                            <asp:SqlDataSource ID="sqdsProducto" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                        SelectCommand="CB_PRODUCT_VENT_P" SelectCommandType="StoredProcedure">  
                                <SelectParameters>
...
<CaptionStyle Font-Bold="True"></CaptionStyle>
                        ...
                        <dx:LayoutItem Caption="Bodega Destino" ColumnSpan="2" CaptionStyle-Font-Bold="true" ClientVisible="false" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
