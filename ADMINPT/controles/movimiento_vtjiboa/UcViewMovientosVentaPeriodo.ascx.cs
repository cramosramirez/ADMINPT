...
{
    public partial class UcViewMovientosVentaPeriodo : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            UCEncabezado.Titulo = "VENTAS POR PERIODO";
        ...
        {
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMoviVentasDiariosP(Convert.ToInt32(cb_bodegaO.Value), Convert.ToDateTime(txt_fechad.Text), Convert.ToDateTime(txt_fechah.Text), Convert.ToString("13,14")));
