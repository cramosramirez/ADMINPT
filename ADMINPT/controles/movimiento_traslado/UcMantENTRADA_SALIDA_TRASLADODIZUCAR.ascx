<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcMantENTRADA_SALIDA_TRASLADODIZUCAR.ascx.cs" Inherits="ADMINPT.controles.movimiento_traslado.UcMantENTRADA_SALIDA_TRASLADODIZUCAR" %>
...
<%@ Register Src="~/controles/movimiento_traslado/UcVistaENTRADA_SALIDA_ENCA_TRASLADODIZUCAR.ascx" TagPrefix="uc1" TagName="UcVistaENTRADA_SALIDA_ENCA_TRASLADODIZUCAR" %>
...
<uc1:UcVistaENTRADA_SALIDA_ENCA_TRASLADODIZUCAR runat="server" id="UcVistaENTRADA_SALIDA_ENCA_TRASLADODIZUCAR" />
