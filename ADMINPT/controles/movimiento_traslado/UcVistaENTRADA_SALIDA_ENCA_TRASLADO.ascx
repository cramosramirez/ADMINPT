<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaENTRADA_SALIDA_ENCA_TRASLADO.ascx.cs" Inherits="ADMINPT.controles.movimiento_traslado.UcVistaENTRADA_SALIDA_ENCA_TRASLADO" %>
...
<dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout">
    ...
    <Items>
        ...
        <dx:LayoutGroup Caption="Información del Movimiento" ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                <dx:LayoutItem Caption="Orden Global Traslado" ColumnSpan="2" CaptionStyle-Font-Bold="true" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
...
<asp:ObjectDataSource ID="odsPRODUCTOAlmaconsa" runat="server" SelectMethod="ObtenerListaVtaDizucar" TypeName="ADMINPT.BL.CPRODUCTO"></asp:ObjectDataSource>
<asp:ObjectDataSource ID="odsPRODUCTOAlmapac" runat="server" SelectMethod="ObtenerListaAlmapac" TypeName="ADMINPT.BL.CPRODUCTO"> 
</asp:ObjectDataSource>
