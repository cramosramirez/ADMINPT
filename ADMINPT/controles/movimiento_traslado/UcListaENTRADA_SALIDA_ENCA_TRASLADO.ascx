<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_ENCA_TRASLADO.ascx.cs" Inherits="ADMINPT.controles.movimiento_traslado.UcListaENTRADA_SALIDA_ENCA_TRASLADO" %>
...
<asp:ObjectDataSource ID="odsLista" runat="server" SelectMethod="ObtenerListaTraslado"  TypeName="ADMINPT.BL.CENTRADA_SALIDA_ENCA">    
