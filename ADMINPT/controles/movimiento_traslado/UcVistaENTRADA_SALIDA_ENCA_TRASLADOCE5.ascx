<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaENTRADA_SALIDA_ENCA_TRASLADOCE5.ascx.cs" Inherits="ADMINPT.controles.movimiento_traslado.UcVistaENTRADA_SALIDA_ENCA_TRASLADOCE5" %>
...
<dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout">
    ...
    <Items>
        ...
        <dx:LayoutGroup Caption="Información del Movimiento" ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                <dx:LayoutItem Caption="Orden Global Traslado" ColumnSpan="2" CaptionStyle-Font-Bold="true" ClientVisible="false" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
...
<%--DETALLE--%>
<asp:ObjectDataSource ID="odsPRODUCTO" runat="server" SelectMethod="ObtenerListaTrasladoC5" TypeName="ADMINPT.BL.CPRODUCTO"></asp:ObjectDataSource>
