<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaENTRADA_SALIDA_ENCA_TRASLADODIZUCAR.ascx.cs" Inherits="ADMINPT.controles.movimiento_traslado.UcVistaENTRADA_SALIDA_ENCA_TRASLADODIZUCAR" %>
