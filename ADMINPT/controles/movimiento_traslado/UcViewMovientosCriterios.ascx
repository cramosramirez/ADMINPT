<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewMovientosCriterios.ascx.cs" Inherits="ADMINPT.controles.movimiento_traslado.UcViewMovientosCriterios" %>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            ...
                            <asp:SqlDataSource ID="sqdsProducto" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                        SelectCommand="CB_PRODUCT_TRASDO_P" SelectCommandType="StoredProcedure">  
                                <SelectParameters>
