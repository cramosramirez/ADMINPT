<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_DETA_TRASLADO.ascx.cs" Inherits="ADMINPT.controles.movimiento_traslado.UcListaENTRADA_SALIDA_DETA_TRASLADO" %>
