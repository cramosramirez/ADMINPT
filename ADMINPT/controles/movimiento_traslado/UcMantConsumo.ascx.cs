...
{
    public partial class UcMantConsumo : System.Web.UI.UserControl
    {
        DateTime dteFecha;
        ...
        {
            UCEncabezado.Titulo = "CONSUMO AGRICOLA";
        ...
        private void InicializarLista()
        {
            ...
            UcConsumoAgricola.Visible = false;
        ...
        private void InicializarDetalle(Boolean EsEdicion)
        {
            ...
            UcConsumoAgricola.Visible = true;
        ...
        protected void UcListaENTRADA_SALIDA_ENCA_Editando(int Identificador)
        {
            ...
            UcConsumoAgricola.Identificador = Identificador;
        }

        protected void _btn_nuevo_Click(object sender, EventArgs e)
        {
            InicializarDetalle(false);
            UcConsumoAgricola.Identificador = 0;
        ...
        {
            string Ret = UcConsumoAgricola.ActualizarTraslado();
