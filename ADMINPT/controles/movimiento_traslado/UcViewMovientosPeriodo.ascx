<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewMovientosPeriodo.ascx.cs" Inherits="ADMINPT.controles.movimiento_traslado.UcViewMovientosPeriodo" %>
