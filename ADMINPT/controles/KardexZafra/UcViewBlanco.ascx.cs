...
namespace ADMINPT.controles.KardexZafra
{
    public partial class UcViewBlanco : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "KARDEX ZAFRA DE AZUCAR BLANCA SC 50KG";
        ...
        public void llenarReporteNotas(DateTime fde, DateTime fht)
        {
            ...
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptBlancoZafra(Convert.ToDateTime(fde), Convert.ToDateTime(fht), Convert.ToInt32(cb_bodegaO.Value), Convert.ToInt32(cb_zafra.Value), Convert.ToInt32(1)));
