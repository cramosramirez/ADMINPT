...
{
    public partial class UcViewMorenaJumboLocal : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            UCEncabezado.Titulo = "KARDEX ZAFRA DE AZUCAR MORENA JUMBO LOCAL 27.18 QQ";
        ...
        public void llenarReporteNotas(DateTime fde, DateTime fht)
        {
            ...
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMorenoJumboLocalZafra(Convert.ToDateTime(fde), Convert.ToDateTime(fht), Convert.ToInt32(cb_bodegaO.Value), Convert.ToInt32(cb_zafra.Value), Convert.ToInt32(6)));
