...
{
    public partial class UcViewMorenaExportacion : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            UCEncabezado.Titulo = "KARDEX ZAFRA DE AZUCAR MORENA EXPORTACION SC 50KG";
        ...
        public void llenarReporteNotas(DateTime fde, DateTime fht)
        {
            ...
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMorenoExportacionZafra(Convert.ToDateTime(fde), Convert.ToDateTime(fht), Convert.ToInt32(cb_bodegaO.Value), Convert.ToInt32(cb_zafra.Value), Convert.ToInt32(3)));
