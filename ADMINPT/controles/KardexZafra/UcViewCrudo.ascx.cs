...
{
    public partial class UcViewCrudo : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            UCEncabezado.Titulo = "KARDEX ZAFRA DE AZUCAR CRUDO A GRANEL";
        ...
        public void llenarReporteNotas(DateTime fde, DateTime fht)
        {
            ...
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptCrudoZafra(Convert.ToDateTime(fde), Convert.ToDateTime(fht), Convert.ToInt32(cb_bodegaO.Value), Convert.ToInt32(cb_zafra.Value), Convert.ToInt32(2)));
