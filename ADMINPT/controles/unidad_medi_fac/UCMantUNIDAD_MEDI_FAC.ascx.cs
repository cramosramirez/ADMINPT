...
namespace ADMINPT.controles.unidad_medi_fac
{
    public partial class UCMantUNIDAD_MEDI_FAC : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "CATALOGO DE UNIDAD MEDIDA FACTURACION";
        ...
        private void InicializarLista()
        {
            ...
            UCListaUNIDAD_MEDI_FAC1.Visible = true;
            UCVistaUNIDAD_MEDI_FAC1.Visible = false;
            UCListaUNIDAD_MEDI_FAC1.CargarDatos();
        }
        ...
        private void InicializarDetalle(Boolean EsEdicion)
        {
            ...
            UCVistaUNIDAD_MEDI_FAC1.Visible = true;
            UCListaUNIDAD_MEDI_FAC1.Visible = false;
        }
        ...
        protected void UCBarraOpciones_OpcionSeleccionada(string x)
        {
            if (x == "Nuevo")
            {
                ...
                UCVistaUNIDAD_MEDI_FAC1.Identificador = 0;
            }
            if (x == "Cancelar")
            {
                InicializarLista();
            ...
            if (x == "Guardar")
            {
                string Ret = UCVistaUNIDAD_MEDI_FAC1.Actualizar();
                if (Ret == string.Empty)
                {
                    InicializarLista();
                }
            ...
            if (x == "Eliminar")
            {
                string Ret = UCVistaUNIDAD_MEDI_FAC1.Eliminar();
                if (Ret == string.Empty)
                {
                    InicializarLista();
                }
        ...
        protected void UCListaUNIDAD_MEDI_FAC1_Editando(int Identificador)
        {
            InicializarDetalle(true);
            UCVistaUNIDAD_MEDI_FAC1.Identificador = Identificador;
        }
