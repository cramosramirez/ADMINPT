<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCVistaUNIDAD_MEDI_FAC.ascx.cs" Inherits="ADMINPT.controles.unidad_medi_fac.UCVistaUNIDAD_MEDI_FAC" %>
...
<dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Theme="Moderno" Width="100%">
    ...
    <Items>
        <dx:LayoutGroup ColCount="5" Caption="Datos de Medida Facturacion"  Name="lgUNIDAD_MEDI_FAC" GroupBoxDecoration="HeadingLine">
            <Items>
                ...
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer runat="server">                        
                        <table class="tablaVista" >
                            <tr>
                                <td class="filaVista" ><dx:ASPxLabel runat="server" ID="lblUNIDAD_MEDI_FAC" Text="Identificador:" ></dx:ASPxLabel></td>
                                <td class="filaVista">
                                ...
                                <td class="filaVista">
                                    <dx:ASPxTextBox ID="txtNOMBRE_UNIDAD" runat="server" Width="400px" >
                                        ...
                                        <ValidationSettings Display="Dynamic">
                                            <RequiredField IsRequired="True" ErrorText="Unidad Medida" />
                                        </ValidationSettings>
                                    </dx:ASPxTextBox>
                                </td>
                            </tr>
