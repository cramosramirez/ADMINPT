...
{
    public partial class UCVistaUNIDAD_MEDI_FAC : System.Web.UI.UserControl
    {
        #region "Propiedades"

        private CUNIDAD_MEDI_FAC Controlador = new CUNIDAD_MEDI_FAC();
        ...
        private void CargarVista()
        {
            ...
            ModoEdicion(true);
            UNIDAD_MEDI_FAC Entidad = Controlador.ObtenerPorId(Identificador);
            if (Entidad != null)
            {
                txtIdentificador.Text = Entidad.ID_UNIDAD_FAC.ToString();
