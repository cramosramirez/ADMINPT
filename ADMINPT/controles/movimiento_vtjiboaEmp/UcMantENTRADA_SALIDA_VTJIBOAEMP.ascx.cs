...
{
    public partial class UcMantENTRADA_SALIDA_VTJIBOAEMP : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "REGISTRO MOVIMIENTOS DE VENTAS JIBOA EMPACADA";
        ...
        private void InicializarLista()
        {
            ...
            UcVistaENTRADA_SALIDA_ENCA_VTJIBOAEMP.Visible = false;
            UcListaENTRADA_SALIDA_ENCA_VTJIBOAEMP.Visible = true;
            UcListaENTRADA_SALIDA_ENCA_VTJIBOAEMP.CargarDatos();
        }
        private void InicializarDetalle(Boolean EsEdicion)
        {
            ...
            UcVistaENTRADA_SALIDA_ENCA_VTJIBOAEMP.Visible = true;
            UcListaENTRADA_SALIDA_ENCA_VTJIBOAEMP.Visible = false;
        }
        ...
        protected void UcListaENTRADA_SALIDA_ENCA_Editando(int Identificador)
        {
            ...
            UcVistaENTRADA_SALIDA_ENCA_VTJIBOAEMP.Identificador = Identificador;
        }
        protected void _btn_nuevo_Click(object sender, EventArgs e)
        {
            InicializarDetalle(false);
            UcVistaENTRADA_SALIDA_ENCA_VTJIBOAEMP.Identificador = 0;
        ...
        {
            string Ret = UcVistaENTRADA_SALIDA_ENCA_VTJIBOAEMP.ActualizarVtaJiboa();
