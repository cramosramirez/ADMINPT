...
{
    public partial class UcDonacion : System.Web.UI.UserControl
    {
        ...
        protected void cbxProducto_TextChanged(object sender, EventArgs e)
        {
            ...
            //IdBodegaDestino();
            CargarConceptosMovi();
            cbxtipoMovimiento.SelectedIndex = 2;
        ...
        private void EncaFact()
        {
            try
            {
                ...
                if (Dt.Rows.Count > 0)
                {
                    ...
                    txtEfectivo.Text = "0"; // Convert.ToString(row["efectivo"].ToString());
                    txtCheque.Text = "0"; //Convert.ToString(row["cheques"].ToString());
                    txtNotaAbono.Text = "0"; //Convert.ToString(row["tarjeta"].ToString());
                    txtDonacion.Text = Convert.ToString(Convert.ToDecimal(row["efectivo"]));
        ...
        private void DetFact()
        {
            ...
            try
            {
                ...
                Conn.cnph.Close();
                Conn.cnph.Open();
                System.Data.OleDb.OleDbCommand Comando = new System.Data.OleDb.OleDbCommand("select  IIF(b.codigoart = '10001           ', '9               ', IIF(b.codigoart = '10002           ', '10              ',IIF(b.codigoart = '10003           ', '11              ',IIF(b.codigoart = '08001           ', '12              ',IIF(b.codigoart = '08002           ', '13              ',IIF(b.codigoart = '08003           ', '14              ',IIF(b.codigoart = '13005           ', '1               ',IIF(b.codigoart = '13008           ', '4               ',IIF(b.codigoart = '0404            ', '5               ', '0               ')))))))))  as codigoart, b.cantidad  from facturas a, detafac b " +
        ...
        private void InsEnc()
        {
            ...
            try
            {
                ...
                Conn.cn.Close();
                Conn.cn.Open();
                SqlCommand guardar = new SqlCommand("CRE_ENTRADA_SALIDA_ENCA_VJIBOA", Conn.cn);
        ...
        private void InsEncDet(int Id)
        {
            ...
            try
            {
                Conn.cn.Close();
                Conn.cn.Open();
                SqlCommand guardar = new SqlCommand("CRE_ENTRADA_SALIDA_DETA_VJIBOA", Conn.cn);
                guardar.CommandType = CommandType.StoredProcedure;
...
#pragma warning restore CS0168 // La variable 'ex' se ha declarado pero nunca se usa
        ...
        protected void _btn_reporteDia_Click(object sender, EventArgs e)
        {
            ...
            if (HostName == "PORTAL")
            {
                string _open = "window.open('/ADMINPT/forms/wfREPORTE.aspx?mv='+'" + mv + "&id=" + Convert.ToString(ibog) + "&f=" + Convert.ToString(dteFecha.Text) + "&cn=" + Convert.ToString("21") + "&bd=" + Convert.ToString("0") + "&rpt=" + TipoRpt + "', '_newtab');";
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), _open, true);
            }
            else if (HostName == "SV1-IT03")
            {
                string _open = "window.open('/forms/wfREPORTE.aspx?mv='+'" + mv + "&id=" + Convert.ToString(ibog) + "&f=" + Convert.ToString(dteFecha.Text) + "&cn=" + Convert.ToString("21") + "&bd=" + Convert.ToString("0") + "&rpt=" + TipoRpt + "', '_newtab');";
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), _open, true);
            }
            else if (HostName == "SV1-ITINJ03.injiboa.local")
            {
