<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcDonacion.ascx.cs" Inherits="ADMINPT.controles.movimiento_vtjiboaEmp.UcDonacion" %>
    ...
    <Items>
        <dx:LayoutGroup Caption="Información del Movimiento" ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                ...
                <dx:LayoutItem Caption="Zafra del producto">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxZafraProd" Font-Bold="true" ForeColor="Maroon"  runat="server" TextField="NOMBRE_ZAFRA" ValueField="ID_ZAFRA" ValueType="System.Int32" AutoPostBack="false" OnTextChanged="cbxZafraProd_TextChanged">
          ...
          <dx:LayoutGroup Caption="Lista de Productos" ClientVisible="true"  ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                ...
                <dx:LayoutItem Caption="" ShowCaption="False" ColumnSpan="3" Width="100%">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
        ...
        <dx:LayoutGroup Caption="Información Cliente" ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cb_fmpago" ClientInstanceName="cb_bodegaO" runat="server"  DataSourceID="SdsListFormaPagos" ValueField="ID_FMPAGO" TextField="NOMBRE" 
                             ...
                             <asp:SqlDataSource ID="SdsListFormaPagos" runat="server" 
                                 ConnectionString="<%$ ConnectionStrings:cn %>" 
                                 SelectCommand="CB_FORMA_PAGO_DONACION" SelectCommandType="StoredProcedure"></asp:SqlDataSource>          
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
                </dx:LayoutItem>
                ...
                <dx:LayoutItem Caption="Donacion"   >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxTextBox ID="txtDonacion" runat="server" AutoCompleteType="Disabled" ClientEnabled="true">
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black">
                                </DisabledStyle>
                               <ClientSideEvents KeyPress="function(s,e){ OnKeyPress(s,e);}" />                               
                            </dx:ASPxTextBox>
...
<asp:ObjectDataSource ID="odsCONCEPTO_MOVI" runat="server" SelectMethod="ObtenerPorIdTMDonacion" TypeName="ADMINPT.BL.CCONCEPTO_MOVI">
    <SelectParameters>
        <asp:Parameter Name="ID_PRODUCTO" DefaultValue="-1" Type="Int32" />
