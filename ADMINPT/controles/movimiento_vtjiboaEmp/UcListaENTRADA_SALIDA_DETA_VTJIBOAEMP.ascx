<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_DETA_VTJIBOAEMP.ascx.cs" Inherits="ADMINPT.controles.movimiento_vtjiboaEmp.UcListaENTRADA_SALIDA_DETA_VTJIBOAEMP" %>
<%@ Register assembly="DevExpress.Web.v20.1, Version=20.1.13.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>

<dx:ASPxGridView ID="gridLista" runat="server" Theme="Moderno" KeyFieldName="ID_ES_DETA" OnInit="gridLista_Init" EnableCallBacks="false" Width="100%"
...
<CellStyle HorizontalAlign="Center"></CellStyle>
        ...
        <dx:GridViewDataTextColumn FieldName="FACTOR" VisibleIndex="9" Caption="Factor" Visible="false" />
        <dx:GridViewDataTextColumn FieldName="FACTORKG" VisibleIndex="9" Caption="Factor" Visible="false" />
