<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_ENCA_VTJIBOAEMP.ascx.cs" Inherits="ADMINPT.controles.movimiento_vtjiboaEmp.UcListaENTRADA_SALIDA_ENCA_VTJIBOAEMP" %>
...
<asp:ObjectDataSource ID="odsLista" runat="server" SelectMethod="ObtenerListaVtJiboa"  TypeName="ADMINPT.BL.CENTRADA_SALIDA_ENCA">    
