<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewMovEstraBpProd.ascx.cs" Inherits="ADMINPT.controles.controlesReportes.UcViewMovEstraBpProd" %>
    ...
    <Items>
        <dx:LayoutGroup Caption="" ColumnCount="3" ShowCaption="false" GroupBoxDecoration="Box"
            ...
            <Items>
                <dx:LayoutItem Caption="Movimientos" ColumnSpan="1" CaptionStyle-Font-Bold="true" ClientVisible="true">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxTiposMovimientos" runat="server" AutoPostBack="true" TextField="DESCRIPCION" ValueField="CODREF" ValueType="System.Int32">
                ...
                <dx:LayoutItem Caption="Fecha Cierre" CaptionSettings-HorizontalAlign="Right">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxDateEdit ID="txt_fecha" ClientInstanceName="txt_fechad" runat="server">
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
