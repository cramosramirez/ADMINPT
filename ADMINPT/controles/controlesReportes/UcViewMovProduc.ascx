<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewMovProduc.ascx.cs" Inherits="ADMINPT.controles.controlesReportes.UcViewMovProduc" %>
...
<table style="width: 100%;">
    <tr>
        <td>
            <dx:ASPxWebDocumentViewer ID="ProduccionRpt" runat="server" EnableViewState="true">
