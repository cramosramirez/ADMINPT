...
{
    public partial class UcViewMovEntradaTraladoEntBodega : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            UCEncabezado.Titulo = "TRASLADOS ENTRE BODEGAS - ENTRADAS";
        ...
        public void llenarReport()
        {
            ...
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMovEntradaTraladoEntBodega(Convert.ToInt32(cb_bodegaO.Value),  Convert.ToInt32(cbxTiposMovimientos.Value), Convert.ToDateTime(txt_fechad.Value), Convert.ToDateTime(txt_fechah.Value), Convert.ToString(cb_zafra.Text)));
