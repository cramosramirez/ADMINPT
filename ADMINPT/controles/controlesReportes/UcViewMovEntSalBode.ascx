<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewMovEntSalBode.ascx.cs" Inherits="ADMINPT.controles.controlesReportes.UcViewMovEntSalBode" %>
...
<dx:ASPxFormLayout ID="FtListEmpresa" CssClass="modal-content" runat="server">
    ...
    <Items>
        <dx:LayoutGroup Caption="" ColumnCount="2" ShowCaption="false" GroupBoxDecoration="Box"
            ...
            <Items>
                <dx:LayoutItem Caption="" ShowCaption="False" CaptionSettings-HorizontalAlign="Right" ColumnSpan="2" ClientVisible="true">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer runat="server">
                            <dx:ASPxRadioButtonList ID="rdOpciones" runat="server" ValueType="System.String" RepeatDirection="Horizontal" SelectedIndex="0">
                                <Items>
                                    <dx:ListEditItem Selected="True" Text="Ingreso" Value="1" />
