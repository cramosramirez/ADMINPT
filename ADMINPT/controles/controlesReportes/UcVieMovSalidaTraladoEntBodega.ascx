<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVieMovSalidaTraladoEntBodega.ascx.cs" Inherits="ADMINPT.controles.controlesReportes.UcVieMovSalidaTraladoEntBodega" %>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            ...
                            <asp:SqlDataSource ID="sqdsBodegaD" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                        SelectCommand="CB_BODEGAD_TRAS_Pf" SelectCommandType="StoredProcedure">   
                                <SelectParameters>
