<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewMovEstraBpProdBlanca.ascx.cs" Inherits="ADMINPT.controles.controlesReportes.UcViewMovEstraBpProdBlanca" %>
