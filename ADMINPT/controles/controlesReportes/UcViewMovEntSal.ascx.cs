...
{
    public partial class UcViewMovEntSal : System.Web.UI.UserControl
    {
        ...
        public void llenarReporteNotas()
        {
            ...
            //{
            //    var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMovBascula(Convert.ToDateTime(txt_fechad.Text), Convert.ToDateTime(txt_fechah.Text), Convert.ToString(cbxHorario.Text), Convert.ToInt32(14), Convert.ToInt32(cbxProductoEntSalRpt.Value), Convert.ToInt32(cbxDestino.Value)));
            //    MovimientoRpt.OpenReport(cachedReportSourceKardex);
            //}
            //else if (Convert.ToInt32(cbxTiposMovimientos.Value) == 3)
            //{
            //    var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMovBascula(Convert.ToDateTime(txt_fechad.Text), Convert.ToDateTime(txt_fechah.Text), Convert.ToString(cbxHorario.Text), Convert.ToInt32(16), Convert.ToInt32(cbxProductoEntSalRpt.Value), Convert.ToInt32(cbxDestino.Value)));
            //    MovimientoRpt.OpenReport(cachedReportSourceKardex);
            //}
        }
