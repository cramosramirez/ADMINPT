<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCVistaORDEN_GLOBAL_TRAS.ascx.cs" Inherits="ADMINPT.controles.orden_global_tras.UCVistaORDEN_GLOBAL_TRAS" %>
...
<script type="text/javascript">
    ...
    function _Cantidad(s, e) {
        var value1 = (speCantidad.GetNumber());
        if (value1 === '') { txtAsignacionO.SetNumber(0); txtSaldo.SetNumber(0); txtAsignacionT.SetNumber(0);}
        if (value1 !== '') { txtAsignacionO.SetNumber(value1); txtSaldo.SetNumber(value1); txtAsignacionT.SetNumber(value1); }
    }
</script>
...
<Paddings PaddingTop="0px"></Paddings>
            <Items>
                ...
                <dx:LayoutItem Caption="Fecha">
                 ...
                 <dx:LayoutItem Caption="Estado">
                  ...
                  <dx:LayoutItem Caption="Solicitante" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>                         
                            <dx:ASPxComboBox ID="cbxSolicitante" runat="server" TextField="NOMBRE" ValueField="ID_SOLICITANTE" ValueType="System.Int32">
                                            <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                            </ValidationSettings>
                                        </dx:ASPxComboBox>
                ...
                <dx:LayoutItem Caption="Referencia">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                           <dx:ASPxComboBox ID="cbxTIPO_REF_TRAS" runat="server" TextField="NOMBRE" ValueField="ID_REF" ValueType="System.Int32" AutoPostBack="true" OnTextChanged="cbxTIPO_REF_TRAS_TextChanged">
                                            <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                            <ValidationSettings Display="Dynamic">
              ...
              <dx:LayoutItem Caption="#Referencia">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                          <dx:ASPxTextBox ID="txtDocumento" runat="server" ClientEnabled="true"  AutoPostBack="false" Text="0" AutoCompleteType="Disabled">
                                            <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                        </dx:ASPxTextBox>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
                ...
                <dx:LayoutItem Caption="Bodega Destino" ColumnSpan="2">
                 ...
                 <dx:LayoutItem Caption="Cantidad">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxSpinEdit ID="speCantidad" ClientInstanceName="speCantidad" runat="server" Number="0" ReadOnly="false" OnValueChanged="speCantidad_ValueChanged1" AutoPostBack ="true" DisplayFormatString="N2"  >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
                 ...
                 <dx:LayoutItem Caption="Asignacion Original">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                       <dx:ASPxSpinEdit ID="txtAsignacionO" ClientInstanceName="txtAsignacionO" runat="server" Number="0" ClientEnabled="false"  DisplayFormatString="N2">
                                            <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                            <ValidationSettings Display="Dynamic">
                ...
                <dx:LayoutItem Caption="Ampliaciones">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                       <dx:ASPxSpinEdit ID="txtAmpliaciones" ClientInstanceName="txtAmpliaciones" runat="server" Number="0" ClientEnabled="false"  DisplayFormatString="N2">
                                            <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                            <ValidationSettings Display="Dynamic">
                                                <RequiredField IsRequired="True" ErrorText="Cantidad" />
                                            </ValidationSettings>
                 ...
                 <dx:LayoutItem Caption="Asignacion Total">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                       <dx:ASPxSpinEdit ID="txtAsignacionT" ClientInstanceName="txtAsignacionT" runat="server" Number="0" ClientEnabled="false"  DisplayFormatString="N2">
                                            <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                            <ValidationSettings Display="Dynamic">
                                                <RequiredField IsRequired="True" ErrorText="Cantidad" />
                                            </ValidationSettings>
                 ...
                 <dx:LayoutItem Caption="Ejecutado">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                       <dx:ASPxSpinEdit ID="txtEjecutado" ClientInstanceName="txtEjecutado" runat="server" Number="0" ClientEnabled="false"  DisplayFormatString="N2">
                                            <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                            <ValidationSettings Display="Dynamic">
                                                <RequiredField IsRequired="True" ErrorText="Cantidad" />
                                            </ValidationSettings>
                ...
                <dx:LayoutItem Caption="Saldo">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                       <dx:ASPxSpinEdit ID="txtSaldo" ClientInstanceName="txtSaldo" runat="server" Number="0" ClientEnabled="false"  DisplayFormatString="N2">
                                            <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                            <ValidationSettings Display="Dynamic">
                                                <RequiredField IsRequired="True" ErrorText="Cantidad" />
                                            </ValidationSettings>
...
<%--DETALLE--%>
<asp:ObjectDataSource ID="odsPRODUCTO" runat="server" SelectMethod="ObtenerListaOrdenGlobal" TypeName="ADMINPT.BL.CPRODUCTO"></asp:ObjectDataSource>
