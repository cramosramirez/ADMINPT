<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewTrasladoMelaza.ascx.cs" Inherits="ADMINPT.controles.ReportesBodegaJiboa.Melaza.UcViewTrasladoMelaza" %>
            ...
            <Items>
                <dx:LayoutGroup Caption="" ColumnCount="2" ShowCaption="false" GroupBoxDecoration="Box"
                    ...
                    <CaptionStyle Font-Bold="True"></CaptionStyle>
                     ...
                     <dx:LayoutItem Caption="Zafra"  Width="100%" CaptionStyle-Font-Bold="true" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxZafra"  Font-Bold ="true"   runat="server" DataSourceID="sqdsZafra" TextField="NOMBRE_ZAFRA" ValueField="ID_ZAFRA" ValueType="System.Int32" AutoPostBack="true">
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
                            </dx:ASPxComboBox>
                            <asp:SqlDataSource ID="sqdsZafra" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
...
<CaptionStyle Font-Bold="True"></CaptionStyle>
                    ...
                    <dx:LayoutItem Caption="Hasta" CaptionSettings-HorizontalAlign="Right" >
                     ...
                     <dx:LayoutItem Caption="Producto"  Width="100%" CaptionStyle-Font-Bold="true" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxProducto"  Font-Bold ="true"   runat="server" DataSourceID="sqdsProducto" TextField="NOMBRE_KARDEX" ValueField="ID_PRODUCTO" ValueType="System.Int32" AutoPostBack="true" OnTextChanged="cbxProducto_TextChanged">
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
...
<CaptionStyle Font-Bold="True"></CaptionStyle>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxBodegaDestino" runat="server" DataSourceID="sqdsBodegaD" TextField="NOMBRE" ValueField="ID_BODEGA" ValueType="System.Int32" AutoPostBack="false"   >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
                            </dx:ASPxComboBox>
                            <asp:SqlDataSource ID="sqdsBodegaD" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                        SelectCommand="CB_BODEGAD_TRAS_P" SelectCommandType="StoredProcedure">   
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="cb_bodegaO" Name="ID_BODEGAO" PropertyName="Value" Type="Int32" />
                                    <asp:ControlParameter ControlID="txt_fechad" DbType="Date" Name="FECHAD" PropertyName="Value" />
                                    <asp:ControlParameter ControlID="txt_fechah" DbType="Date" Name="FECHAH" PropertyName="Value" />
