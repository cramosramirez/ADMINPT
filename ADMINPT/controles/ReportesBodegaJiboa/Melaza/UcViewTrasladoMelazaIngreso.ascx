<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewTrasladoMelazaIngreso.ascx.cs" Inherits="ADMINPT.controles.ReportesBodegaJiboa.Melaza.UcViewTrasladoMelazaIngreso" %>
  ...
  <dx:ASPxFormLayout ID="FtListEmpresa" CssClass="modal-content" runat="server">
            ...
            <Items>
                ...
                <dx:LayoutItem Caption="Movimientos" ColumnSpan="2" CaptionStyle-Font-Bold="true" ClientVisible="true">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxTiposMovimientos" runat="server" AutoPostBack="true" TextField="DESCRIPCION" ValueField="CODREF" ValueType="System.Int32" Enabled="false"  >
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxDateEdit ID="txt_fechad" ClientInstanceName="txt_fechad" runat="server"  AutoPostBack="true">
                              ...
                              <ClientSideEvents ValueChanged="function(s, e) {ldnPanel.Show(); e.processOnServer = true;}" />
                            </dx:ASPxDateEdit>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
