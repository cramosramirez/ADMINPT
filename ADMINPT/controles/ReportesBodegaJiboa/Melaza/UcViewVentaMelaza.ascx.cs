...
{
    public partial class UcViewVentaMelaza : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            ...
            {
                UCEncabezado.Titulo = "VENTA MELAZA";
        ...
        {
            cbxProducto.DataSource = CDats._CB_PRODUCTO_ENT_SAL_RPT();
            cbxProducto.DataBind();
            cbxProducto.SelectedIndex = 5;
        }
        ...
        {
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptVentasMelaza(29,Convert.ToDateTime(dteFechaInicial.Value), Convert.ToDateTime(dteFechaFinal.Value), "14",Convert.ToInt32(cbxZafra.Value)));
