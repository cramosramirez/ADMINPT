<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewVentaBM.ascx.cs" Inherits="ADMINPT.controles.ReportesBodegaJiboa.VentaBM.UcViewVentaBM" %>
...
<dx:ASPxFormLayout ID="FtListEmpresa" CssClass="modal-content" runat="server">
    ...
    <Items>
        <dx:LayoutGroup Caption="" ColumnCount="2" ShowCaption="false" GroupBoxDecoration="Box"
            ...
            <Items>
                <dx:LayoutItem Caption="Zafra" ColumnSpan="2" CaptionStyle-Font-Bold="true" ClientVisible="true">
