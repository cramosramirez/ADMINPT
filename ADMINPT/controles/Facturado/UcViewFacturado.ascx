<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewFacturado.ascx.cs" Inherits="ADMINPT.controles.Facturado.UcViewFacturado" %>
            ...
            <Items>
                <dx:LayoutGroup Caption="" ColumnCount="2" ShowCaption="false" GroupBoxDecoration="Box"
                                ...
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxRadioButtonList ID="rdOpciones" runat="server" ValueType="System.String" RepeatDirection="Horizontal" SelectedIndex="0">
                                        <Items>
                                            ...
                                            <dx:ListEditItem Text="FACTURADO" Value="2" />
                                            <dx:ListEditItem Text="DESPACHADO" Value="3" />
                                            <dx:ListEditItem Text="PENDIENTES" Value="4" />
                                        </Items>
                   ...
                   <dx:LayoutItem Caption="Fecha Hasta" CaptionSettings-HorizontalAlign="Right">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxDateEdit ID="txt_fechah" ClientInstanceName="txt_fechad" runat="server"  >
                                        <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                        <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithText" ErrorText="requerido!!!" ErrorTextPosition="Right">
                                            <RequiredField ErrorText="requerido!!!" IsRequired="True" />
                                        </ValidationSettings>
