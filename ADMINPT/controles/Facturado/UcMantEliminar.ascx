<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcMantEliminar.ascx.cs" Inherits="ADMINPT.controles.Facturado.UcMantEliminar" %>
...
<dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server"></dx:ASPxFormLayout>
  <dx:ASPxFormLayout ID="FtListEmpresa" CssClass="modal-content" runat="server">
            ...
            <Items>
                <dx:LayoutGroup Caption="Documento" ShowCaption="False" ColumnCount="2"  GroupBoxDecoration="Box"
                    ...
                    <CaptionStyle Font-Bold="True"></CaptionStyle>
                        ...
                        <dx:LayoutItem Caption="N° (NR / CCF/ FA)" CaptionSettings-HorizontalAlign="Right">
                         ...
                         <dx:LayoutItem Caption="Observación" ClientVisible="false" CaptionSettings-HorizontalAlign="Right" ColumnSpan="2">
                            <LayoutItemNestedControlCollection>
