<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_DETA_CFEXPRES.ascx.cs" Inherits="ADMINPT.controles.movimientoConfigExpress.UcListaENTRADA_SALIDA_DETA_CFEXPRES" %>
<%@ Register assembly="DevExpress.Web.v20.1, Version=20.1.13.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>

<dx:ASPxGridView ID="gridLista" runat="server" Theme="Moderno" KeyFieldName="ID_ES_DETA" OnInit="gridLista_Init" EnableCallBacks="false" OnRowCommand="gridLista_RowCommand" OnCustomUnboundColumnData="gridLista_CustomUnboundColumnData" OnRowDeleting="gridLista_RowDeleting" OnRowDeleted="gridLista_RowDeleted">
    <SettingsPager>
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="REFERENCIA_DETA" VisibleIndex="10" Caption="Factor" Visible="false" />
                                    <dx:GridViewCommandColumn Name="delete" Caption=" " Width="30" ShowDeleteButton="True" ShowInCustomizationForm="True" VisibleIndex="11" Visible="false">
