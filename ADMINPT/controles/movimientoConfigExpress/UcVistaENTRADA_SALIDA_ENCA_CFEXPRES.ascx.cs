...
{
    public partial class UcVistaENTRADA_SALIDA_ENCA_CFEXPRES : System.Web.UI.UserControl
    {
        #region "Propiedades"
        ...
        public string ActualizarTraslado()
        {
            ...
            Controlador.ActualizarTrasladoCfExpres(ref Entidad);
            EntidadDt.ID_ES_ENCA = Entidad.ID_ES_ENCA;
                Result = Convert.ToString(ControladorDt.ActualizarTrasladoCfExpres(EntidadDt));
            //}
        ...
        private void Nuevo()
        {
            ...
            UcListaENTRADA_SALIDA_DETA_CFEXPRES._gridLista.DataSource = DT;
            UcListaENTRADA_SALIDA_DETA_CFEXPRES._gridLista.DataBind();
