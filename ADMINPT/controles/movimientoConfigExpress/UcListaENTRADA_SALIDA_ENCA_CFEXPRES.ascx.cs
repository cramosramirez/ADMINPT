...
{
    public partial class UcListaENTRADA_SALIDA_ENCA_CFEXPRES : System.Web.UI.UserControl
    {
        ...
        protected void gridLista_CustomUnboundColumnData(object sender, DevExpress.Web.ASPxGridViewColumnDataEventArgs e)
        {
            ...
            else if (e.Column.FieldName == "NOMBRE_BODEGAD")
            {
            ...
            {
                ENTRADA_SALIDA_DETA lEntidad = new CENTRADA_SALIDA_DETA().ObtenerPorIdT((int)e.GetListSourceFieldValue("ID_ES_ENCA"));
                if (lEntidad != null)
