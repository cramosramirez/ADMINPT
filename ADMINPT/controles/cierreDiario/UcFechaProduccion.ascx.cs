...
{
    public partial class UcFechaProduccion : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            UCEncabezado.Titulo = "CAMBIO DE FECHA DE PRODUCCION";
        ...
        protected void _btn_guardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    cn.Close();
                    cn.Open();
                    SqlCommand guardar = new SqlCommand("CRE_FECHA_PRODUCCION", cn);
