<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaMARCA.ascx.cs" Inherits="ADMINPT.controles.marca.UcVistaMARCA" %>
...
<dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Theme="Moderno" Width="100%">
    ...
    <Items>
        <dx:LayoutGroup ColCount="5" Caption="Datos de Marca"  Name="lgMarca" GroupBoxDecoration="HeadingLine">
            <Items>
