...
{
    public partial class UcMantProduccionMorena_Exp : System.Web.UI.UserControl
    {
        #region "Propiedades"
        ...
        {
            UCEncabezado.Titulo = "PRODUCCION POR TARIMA EXPORTACION SC 50KG";
            CargarListas();
        ...
        public void Dt()
        {
            try
            {
                ...
                Conn.cn.Open();
                DataTable Dt;
                Dt = CDats._VIEW_MOVIMIENTOS_WINDOWS(Convert.ToInt32(11)); //PRODUCCION TARIMAS MORENA
                if (Dt.Rows.Count > 0)
                {
