<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcMantProduccionCruda.ascx.cs" Inherits="ADMINPT.controles.movimientos_bulto.UcMantProduccionCruda" %>
...
<dx:ASPxLabel ID="lbl_mensaje" runat="server" Text="" ForeColor="Green" Font-Size="Large" ClientVisible ="false"></dx:ASPxLabel>
...
<Paddings PaddingTop="2px"></Paddings>
            ...
            <Items>
                <dx:LayoutItem Caption="Orden Traslado" ColumnSpan="2" CaptionStyle-Font-Bold="true" ClientVisible="false"  >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
...
<CaptionStyle Font-Bold="True"></CaptionStyle>
                ...
                <dx:LayoutItem Caption="Fecha">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxDateEdit ID="dteFecha" runat="server" EditFormat="Custom" EditFormatString="dd/MM/yyyy"  ClientEnabled="true" >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
                ...
                <dx:LayoutItem Caption="Nº Documento" ClientVisible="true">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                ...
                <dx:LayoutItem Caption="Horario" CaptionStyle-Font-Bold="true" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                           <dx:ASPxComboBox ID="cbHorario" runat="server"  TextField="NOMBREDT" ValueField="ID_ORDEN_TRAS" ValueType="System.Int32"  Border-BorderColor="#20c997">
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <table>
                                <tr>
                                    <td>
 <dx:ASPxTextBox ID="txtCodbarra" runat="server" AutoCompleteType="Disabled" OnTextChanged="txtCodbarra_TextChanged" AutoPostBack="true" ClientVisible="false" >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black">
                                </DisabledStyle>
                                <ClientSideEvents KeyPress="function(s,e){ Numericint(s,e);}" />                               
                            </dx:ASPxTextBox>
                                     ...
                                     <td>
                            <dx:ASPxLabel ID="lbIdentificadorEncT" runat="server" Text=""  ClientVisible="false"></dx:ASPxLabel>
                                    </td>
                                     <td>
                            <dx:ASPxLabel ID="lbIdentificadorEnc" runat="server" Text=""  ClientVisible="false"></dx:ASPxLabel>
                                    </td>
                                </tr>
                            </table>
                ...
                <dx:LayoutItem Caption="Producto" ColumnSpan="3" Width="100%" CaptionStyle-Font-Bold="true" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxProducto"  Font-Bold ="true"   runat="server" TextField="NOMBRE_KARDEX" ClientEnabled="false"  ValueField="ID_PRODUCTO" ValueType="System.Int32" AutoPostBack="true" OnTextChanged="cbxProducto_TextChanged"   >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
...
<CaptionStyle Font-Bold="True"></CaptionStyle>
                ...
                <dx:LayoutItem Caption="Bodega Origen" ColumnSpan="2"  >
                 ...
                 <dx:LayoutItem Caption="Cantidad" CaptionStyle-Font-Bold="true" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxSpinEdit ID="speCantidad" ClientInstanceName="speCantidad" runat="server" Number="0" DecimalPlaces="2" AllowMouseWheel="false" ReadOnly="false" OnValueChanged="speCantidad_ValueChanged" AutoPostBack="false" DisplayFormatString="N2"   >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>                                
                            ...
                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Disponible  " ForeColor="Green" Visible="false"></dx:ASPxLabel>
                            <dx:ASPxLabel ID="lblSaldo" runat="server" Text="" ForeColor="Green" Visible="false"></dx:ASPxLabel>
...
<CaptionStyle Font-Bold="True"></CaptionStyle>
                 ...
                 <dx:LayoutItem Caption="Codigo de Barra" ClientVisible="false">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxTextBox ID="txtCodbarraT" runat="server" AutoCompleteType="Disabled" OnTextChanged="txtCodbarraT_TextChanged" AutoPostBack="true"  >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black">
                                </DisabledStyle>
                                <ClientSideEvents KeyPress="function(s,e){ Numericint(s,e);}" />     
                                <ValidationSettings Display="Dynamic">
                ...
                <dx:LayoutItem Caption="Tarima" ClientVisible="false">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxTextBox ID="txtTarima" runat="server" ClientEnabled="false">
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black">
                                </DisabledStyle>
                 ...
                 <dx:LayoutItem Caption="Observación" ClientVisible="false" ColumnSpan="3">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
        ...
        <dx:LayoutGroup Caption="Información Bodega Destino" ClientVisible="false" ColCount="4" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
<Paddings PaddingTop="2px"></Paddings>
...
<CaptionStyle Font-Bold="True"></CaptionStyle>
                ...
                <dx:LayoutItem Caption="Nit" CaptionStyle-Font-Bold="true" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
...
<asp:ObjectDataSource ID="odsCONCEPTO_MOVI" runat="server" SelectMethod="ObtenerPorIdTMProduc" TypeName="ADMINPT.BL.CCONCEPTO_MOVI">
    <SelectParameters>
        <asp:Parameter Name="ID_PRODUCTO" DefaultValue="-1" Type="Int32" />
