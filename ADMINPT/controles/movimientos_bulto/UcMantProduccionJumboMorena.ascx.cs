...
{
    public partial class UcMantProduccionJumboMorena : System.Web.UI.UserControl
    {
        #region "Propiedades"
        ...
        {
            UCEncabezado.Titulo = "PRODUCCION POR JUMBO";
            CargarListas();
        ...
        public void Dt()
        {
            try
            {
                ...
                Conn.cn.Open();
                DataTable Dt;
                Dt = CDats._VIEW_MOVIMIENTOS_WINDOWS(Convert.ToInt32(8)); //PRODUCCION JUMBO MORENA
                if (Dt.Rows.Count > 0)
                {
...
#pragma warning restore CS0168 // La variable 'ex' se ha declarado pero nunca se usa
        ...
        //        guardar.Parameters.AddWithValue("@ID_ES_ENCA", Convert.ToInt32(lbIdentificadorEnc.Text));
        //        guardar.Parameters.AddWithValue("@ID_TARIMA", DBNull.Value );//Convert.ToInt32(txtCodbarraT.Text));
        //        guardar.Parameters.AddWithValue("@FECHA", Convert.ToDateTime(dteFecha.Text));
        //        guardar.Parameters.AddWithValue("@NUM_DOC", txt_ndocument.Text);
        //        guardar.Parameters.AddWithValue("@ID_PRODUCTO", Convert.ToInt32(cbx_Producto.Value));
