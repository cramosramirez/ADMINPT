<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcMantProduccionJumboMorena.ascx.cs" Inherits="ADMINPT.controles.movimientos_bulto.UcMantProduccionJumboMorena" %>
    ...
    <Items>
        ...
        <dx:LayoutGroup Caption="Información del Movimiento" ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                ...
                <dx:LayoutItem Caption="Nº Documento" ClientVisible="false">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
...
<Border BorderColor="#20C997"></Border>
 ...
 <dx:ASPxTextBox ID="txtCodbarra" runat="server" AutoCompleteType="Disabled" OnTextChanged="txtCodbarra_TextChanged" AutoPostBack="true" ClientVisible="false" >
                            ...
                            <dx:ASPxLabel ID="lbIdentificadorEnc" runat="server" Text=""  ClientVisible="false"></dx:ASPxLabel>
                                    ...
                                    <td>
                            <dx:ASPxLabel ID="lbcodtm" runat="server" Text=""  ClientVisible="false"></dx:ASPxLabel>
                                    </td>
                                </tr>
                            </table>
                ...
                <dx:LayoutItem Caption="Producto" ColumnSpan="3" Width="100%" CaptionStyle-Font-Bold="true" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxProducto"  Font-Bold ="true"   runat="server" ClientEnabled="false" TextField="NOMBRE_KARDEX" ValueField="ID_PRODUCTO" ValueType="System.Int32" AutoPostBack="true" OnTextChanged="cbxProducto_TextChanged"   >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
                ...
                <dx:LayoutItem Caption="Bodega Origen" ColumnSpan="2"  >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxBodegaOrigen" runat="server" TextField="NOMBRE" ValueField="ID_BODEGA" ClientEnabled="false"  ValueType="System.Int32" AutoPostBack="true" OnTextChanged="cbxBodegaOrigen_TextChanged"   >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                   <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
