<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewMovientosPeriodo.ascx.cs" Inherits="ADMINPT.controles.movimientos_bulto.UcViewMovientosPeriodo" %>
  ...
  <dx:ASPxFormLayout ID="FtListEmpresa" CssClass="modal-content" runat="server">
            ...
            <Items>
                <dx:LayoutGroup Caption="" ColumnCount="2" ShowCaption="false" GroupBoxDecoration="Box"
                    ...
                    <Items>  
                        <dx:LayoutItem Caption="Bodega" ColumnSpan="2" CaptionStyle-Font-Bold="false" ClientVisible="true">
