<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcMantProduccionMorenaSc25kg.ascx.cs" Inherits="ADMINPT.controles.movimientos_bulto.UcMantProduccionMorenaSc25kg" %>
...
<CaptionStyle Font-Bold="True"></CaptionStyle>
                ...
                <dx:LayoutItem Caption="Bodega Origen" ColumnSpan="2"  >
                 ...
                 <dx:LayoutItem Caption="Codigo de Barra">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
