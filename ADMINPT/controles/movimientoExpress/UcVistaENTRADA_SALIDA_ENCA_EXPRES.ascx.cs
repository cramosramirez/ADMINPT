...
{
    public partial class UcVistaENTRADA_SALIDA_ENCA_EXPRES : System.Web.UI.UserControl
    {
        #region "Propiedades"
        ...
        private void CargarVistaCodBarra()
        {
            ...
            ENTRADA_SALIDA_ENCA Entidad = Controlador.ObtenerPorIdT(Convert.ToInt32(txt_CodCaptura.Text));
            if (Entidad != null)
            {
            ...
            ENTRADA_SALIDA_DETA EntidadDt = ControladorDt.ObtenerPorIdEncT(Convert.ToInt32(txt_CodCaptura.Text));
            if (EntidadDt != null)
            {
                //DETALLE
                ...
                cbxPrestanciontras.Value = EntidadDt.ID_PRESEN_TRAS;
                cbxUnidad.Value = EntidadDt.ID_UNIDAD_FAC;
                speCantidad.Value = EntidadDt.CANTIDAD;
                speFactor.Value = EntidadDt.FACTOR;
                //EntidadDt.REFERENCIA_DETA = Guid.NewGuid();
                speFactorKg.Value = EntidadDt.FACTORKG;
                ...
                speCantidad.Value = Convert.ToDecimal(EntidadDt.CANTIDAD);
        ...
        public string ActualizarTrasladoExpres()
        {
            ...
            Controlador.ActualizarTrasladoExpres(ref Entidad);
            EntidadDt.ID_ES_ENCA = Entidad.ID_ES_ENCA;
            Session["ID_ES_ENCA"] = Entidad.ID_ES_ENCA;
                Result = Convert.ToString(ControladorDt.ActualizarTrasladoExpres(EntidadDt));
            }
        ...
        private void Nuevo()
        {
            ...
            UcListaENTRADA_SALIDA_DETA_EXPRES._gridLista.DataSource = DT;
            UcListaENTRADA_SALIDA_DETA_EXPRES._gridLista.DataBind();
...
#pragma warning restore CS0168 // La variable 'ex' se ha declarado pero nunca se usa
        ...
        protected void txt_CodCaptura_TextChanged(object sender, EventArgs e)
        {
            ...
            {
               // txtIdentificador.Text = txt_CodCaptura.Text;
                CargarVistaCodBarra();
            }
