...
{
    public partial class UcMantENTRADA_SALIDA_EXPRES : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "REGISTRO MOVIMIENTOS DE TRASLADO EXPRESS";
        ...
        private void InicializarLista()
        {
            ...
            UcVistaENTRADA_SALIDA_ENCA_EXPRES.Visible = false;
            UcListaENTRADA_SALIDA_ENCA_EXPRES.Visible = true;
            UcListaENTRADA_SALIDA_ENCA_EXPRES.CargarDatos();
        }
        private void InicializarDetalle(Boolean EsEdicion)
        {
            ...
            UcVistaENTRADA_SALIDA_ENCA_EXPRES.Visible = true;
            UcListaENTRADA_SALIDA_ENCA_EXPRES.Visible = false;
        }
        ...
        protected void UcListaENTRADA_SALIDA_ENCA_Editando(int Identificador)
        {
            ...
            UcVistaENTRADA_SALIDA_ENCA_EXPRES.Identificador = Identificador;
        }

        protected void _btn_nuevo_Click(object sender, EventArgs e)
        {
            InicializarDetalle(false);
            UcVistaENTRADA_SALIDA_ENCA_EXPRES.Identificador = 0;
        ...
        {
            string Ret = UcVistaENTRADA_SALIDA_ENCA_EXPRES.ActualizarTrasladoExpres();
            ...
            if (Convert.ToString(Ret) != "0")
            {
                ...
                UCBarraNavegacion.btn_atras.Visible = false;
                InicializarLista();               
                Response.Redirect("~/forms/wfMantENTRADA_SALIDA_EXPRES.aspx");
