<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_DETA_EXPRES.ascx.cs" Inherits="ADMINPT.controles.movimientoExpress.UcListaENTRADA_SALIDA_DETA_EXPRES" %>
