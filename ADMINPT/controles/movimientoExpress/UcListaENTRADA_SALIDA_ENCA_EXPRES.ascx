<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_ENCA_EXPRES.ascx.cs" Inherits="ADMINPT.controles.movimientoExpress.UcListaENTRADA_SALIDA_ENCA_EXPRES" %>
...
<asp:ObjectDataSource ID="odsLista" runat="server" SelectMethod="ObtenerListaTrasladoInterno"  TypeName="ADMINPT.BL.CENTRADA_SALIDA_ENCA">    
