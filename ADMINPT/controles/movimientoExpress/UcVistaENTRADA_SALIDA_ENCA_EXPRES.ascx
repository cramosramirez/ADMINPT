<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaENTRADA_SALIDA_ENCA_EXPRES.ascx.cs" Inherits="ADMINPT.controles.movimientoExpress.UcVistaENTRADA_SALIDA_ENCA_EXPRES" %>
<%@ Register Assembly="DevExpress.Web.v20.1, Version=20.1.13.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<%@ Register Src="~/controles/movimientoExpress/UcListaENTRADA_SALIDA_DETA_EXPRES.ascx" TagPrefix="uc1" TagName="UcListaENTRADA_SALIDA_DETA_EXPRES" %>
...
<dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout">
    ...
    <Items>
        ...
        <dx:LayoutGroup Caption="Información del Movimiento" ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                 <dx:LayoutItem Caption="Codigo de Barras Tarima" ColumnSpan="2">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
        ...
        <dx:LayoutGroup Caption="Lista de Productos" ClientVisible="false"  ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                ...
                <dx:LayoutItem Caption="" ShowCaption="False" ColumnSpan="3">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <uc1:UcListaENTRADA_SALIDA_DETA_EXPRES runat="server" ID="UcListaENTRADA_SALIDA_DETA_EXPRES" />
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
                </dx:LayoutItem>
            </Items>
