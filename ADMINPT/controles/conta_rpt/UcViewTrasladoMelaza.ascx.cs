...
namespace ADMINPT.controles.conta_rpt
{
    public partial class UcViewTrasladoMelaza : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "TRASLADOS DE MELAZA";
        ...
        {
            var cachedReportSourceKardex = new CachedReportSourceWeb(new Rpt_TrasladoMelaza(Convert.ToInt32(cb_bodegaO.Value), Convert.ToInt32(cbxBodegaDestino.Value), Convert.ToInt32(cb_zafra.Value), Convert.ToDateTime(txt_fechad.Text), Convert.ToDateTime(txt_fechah.Text)));
