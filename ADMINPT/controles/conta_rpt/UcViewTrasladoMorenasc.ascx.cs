...
{
    public partial class UcViewTrasladoMorenasc : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            UCEncabezado.Titulo = "TRASLADOS DE AZUCAR MORENO LOCAL SC 50KG";
        ...
        {
            var cachedReportSourceKardex = new CachedReportSourceWeb(new Rpt_TrasladoMorenasc(Convert.ToInt32(cb_bodegaO.Value), Convert.ToInt32(cbxBodegaDestino.Value), Convert.ToInt32(cb_zafra.Value), Convert.ToDateTime(txt_fechad.Text), Convert.ToDateTime(txt_fechah.Text)));
