<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewTrasladoBlancosc.ascx.cs" Inherits="ADMINPT.controles.conta_rpt.UcViewTrasladoBlancosc" %>
                        ...
                        <dx:LayoutItemNestedControlContainer>
                            ...
                            <asp:SqlDataSource ID="sqdsBodegaD" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                ...
                                <SelectParameters>
                                    ...
                                    <asp:Parameter Name="ID_PRODUCTO" Type="Int32" DefaultValue="1" />
                                    </SelectParameters>
                                    </asp:SqlDataSource>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
