<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewTrasladoMorenajblocal.ascx.cs" Inherits="ADMINPT.controles.conta_rpt.UcViewTrasladoMorenajblocal" %>
                        ...
                        <dx:LayoutItemNestedControlContainer>
                            ...
                            <asp:SqlDataSource ID="sqdsBodegaD" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                ...
                                <SelectParameters>
                                    ...
                                    <asp:Parameter Name="ID_PRODUCTO" Type="Int32" DefaultValue="6" />
                                    </SelectParameters>
                                    </asp:SqlDataSource>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
