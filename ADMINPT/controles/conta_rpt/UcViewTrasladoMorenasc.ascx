<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewTrasladoMorenasc.ascx.cs" Inherits="ADMINPT.controles.conta_rpt.UcViewTrasladoMorenasc" %>
                        ...
                        <dx:LayoutItemNestedControlContainer>
                            ...
                            <asp:SqlDataSource ID="sqdsBodegaD" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                ...
                                <SelectParameters>
                                    ...
                                    <asp:Parameter Name="ID_PRODUCTO" Type="Int32" DefaultValue="4" />
                                    </SelectParameters>
                                    </asp:SqlDataSource>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
