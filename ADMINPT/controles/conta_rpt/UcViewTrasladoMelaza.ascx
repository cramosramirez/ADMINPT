<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcViewTrasladoMelaza.ascx.cs" Inherits="ADMINPT.controles.conta_rpt.UcViewTrasladoMelaza" %>
                        ...
                        <dx:LayoutItemNestedControlContainer>
                            ...
                            <asp:SqlDataSource ID="sqdsBodegaD" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                ...
                                <SelectParameters>
                                    ...
                                    <asp:Parameter Name="ID_PRODUCTO" Type="Int32" DefaultValue="5" />
                                    </SelectParameters>
                                    </asp:SqlDataSource>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
