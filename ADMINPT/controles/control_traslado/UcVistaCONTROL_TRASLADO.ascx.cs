...
{
    public partial class UcVistaCONTROL_TRASLADO : System.Web.UI.UserControl
    {
        #region "Propiedades"

        private CCONTROL_TRASLADO Controlador = new CCONTROL_TRASLADO();
        ...
        private void CargarVista()
        {
            ...
            ModoEdicion(true);
            CONTROL_TRASLADO Entidad = Controlador.ObtenerPorId(Identificador);
            if (Entidad != null)
            {
                txtIdentificador.Text = Entidad.ID_CONTROL_TRAS.ToString();
