<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaCONTROL_TRASLADO.ascx.cs" Inherits="ADMINPT.controles.control_traslado.UcVistaCONTROL_TRASLADO" %>
