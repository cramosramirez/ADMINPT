<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_ENCA_DESPACHO.ascx.cs" Inherits="ADMINPT.controles.movimiento_despacho.UcListaENTRADA_SALIDA_ENCA_DESPACHO" %>
...
<asp:ObjectDataSource ID="odsLista" runat="server" SelectMethod="ObtenerListaDespacho"  TypeName="ADMINPT.BL.CENTRADA_SALIDA_ENCA">    
