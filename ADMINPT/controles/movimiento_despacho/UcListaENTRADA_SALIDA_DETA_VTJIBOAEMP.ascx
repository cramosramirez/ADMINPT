<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_DETA_VTJIBOAEMP.ascx.cs" Inherits="ADMINPT.controles.movimiento_despacho.UcListaENTRADA_SALIDA_DETA_VTJIBOAEMP" %>
