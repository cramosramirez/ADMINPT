<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaENTRADA_SALIDA_ENCA_ESP.ascx.cs" Inherits="ADMINPT.controles.movimiento_esp.UcVistaENTRADA_SALIDA_ENCA_ESP" %>

<%@ Register Assembly="DevExpress.Web.v20.1, Version=20.1.13.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<%@ Register Src="~/controles/movimiento_esp/UcListaENTRADA_SALIDA_DETA_ESP.ascx" TagPrefix="uc1" TagName="UcListaENTRADA_SALIDA_DETA_ESP" %>
...
<dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout">
    ...
    <Items>
        <dx:LayoutGroup Caption="Información del Movimiento" ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                 <dx:LayoutItem Caption="Nº Documento" ClientVisible="false" ColumnSpan="3">
               ...
               <dx:LayoutItem Caption="Producto" ColumnSpan="3" Width="100%">
                ...
                <dx:LayoutItem Caption="Bodega Origen" ColumnSpan="2">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxBodegaDestino" runat="server" TextField="NOMBRE" ValueField="ID_BODEGA" ValueType="System.Int32" AutoPostBack="true" OnTextChanged="cbxBodegaOrigen_TextChanged">
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                   <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
                ...
                <dx:LayoutItem Caption="Cantidad">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>   
                            <dx:ASPxSpinEdit ID="speCantidad" ClientInstanceName="speCantidad" runat="server" Number="0" ReadOnly="false" HorizontalAlign="Right" OnValueChanged="speCantidad_ValueChanged"  AutoPostBack="false" DisplayFormatString="N2" >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
                       ...
                       <dx:LayoutItem Caption="Observación" Width="100%" ColumnSpan="3" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                           <dx:ASPxButton ID="btnAgregarProductos" runat="server" ClientVisible="false"  Text="Agregar producto a la lista" Width="200px" OnClick="btnAgregarProductos_Click">
                                            <Image IconID="actions_add_16x16">
                                            </Image>
                                        </dx:ASPxButton>
                                        <dx:ASPxButton ID="btnAgregarProductos0" runat="server"  ClientVisible="false" OnClick="btnAgregarProductos_Click" Text="Quitar producto de la lista" Width="200px">
                 ...
                 <dx:LayoutItem Caption="" ClientVisible ="false">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <uc1:UcListaENTRADA_SALIDA_DETA_ESP runat="server" ID="UcListaENTRADA_SALIDA_DETA_ESP"   />
                              </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
                    <CaptionSettings HorizontalAlign="Right"></CaptionSettings>
                </dx:LayoutItem>
...
<asp:ObjectDataSource ID="odsCONCEPTO_MOVI" runat="server" SelectMethod="ObtenerPorIdTMEspcial" TypeName="ADMINPT.BL.CCONCEPTO_MOVI">
    <SelectParameters>
        <asp:Parameter Name="ID_PRODUCTO" DefaultValue="-1" Type="Int32" />
