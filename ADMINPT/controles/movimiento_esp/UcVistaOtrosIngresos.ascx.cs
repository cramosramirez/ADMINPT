...
{
    public partial class UcVistaOtrosIngresos : System.Web.UI.UserControl
    {
        #region "Propiedades"
        ...
        public string ActualizarEspecial()
        {
            ...
            Entidad.ID_BODEGAO = 0;       //Convert.ToInt32(cbxBodegaOrigen.Value);
            ...
            ControladorDt.ActualizarEspecial(EntidadDt);
