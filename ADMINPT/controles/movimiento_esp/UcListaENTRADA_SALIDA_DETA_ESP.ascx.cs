...
{
    public partial class UcListaENTRADA_SALIDA_DETA_ESP : System.Web.UI.UserControl
    {
        ...
        protected void gridLista_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            //    //Dim BuildingID As String = e.Keys(buildingGrid.KeyFieldName)


            //    //DT.Rows.Remove(DT.Rows.Find(0));
