<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaOtrosIngresos.ascx.cs" Inherits="ADMINPT.controles.movimiento_esp.UcVistaOtrosIngresos" %>
            ...
            <Items>
               ...
               <dx:LayoutItem Caption="Producto" ColumnSpan="3" Width="100%">
                ...
                <dx:LayoutItem Caption="Cantidad">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>   
                            <dx:ASPxSpinEdit ID="speCantidad" ClientInstanceName="speCantidad" runat="server" Number="0" ReadOnly="false" HorizontalAlign="Right" OnValueChanged="speCantidad_ValueChanged"  AutoPostBack="false">
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
