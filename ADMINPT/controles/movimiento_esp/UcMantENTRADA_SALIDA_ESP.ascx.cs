...
{
    public partial class UcMantENTRADA_SALIDA_ESP : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "APERTURA / AJUSTES DE INGRESOS-EGRESOS";
        ...
        private void InicializarLista()
        {
            ...
            UcVistaENTRADA_SALIDA_ENCA_ESP.Visible = false;
        ...
        private void InicializarDetalle(Boolean EsEdicion)
        {
            ...
            UcVistaENTRADA_SALIDA_ENCA_ESP.Visible = true;
        ...
        protected void UcListaENTRADA_SALIDA_ENCA_ESP_Editando(int Identificador)
        {
            ...
            UcVistaENTRADA_SALIDA_ENCA_ESP.Identificador = Identificador;
        }
