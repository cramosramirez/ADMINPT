<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_DETA_ESP.ascx.cs" Inherits="ADMINPT.controles.movimiento_esp.UcListaENTRADA_SALIDA_DETA_ESP" %>
