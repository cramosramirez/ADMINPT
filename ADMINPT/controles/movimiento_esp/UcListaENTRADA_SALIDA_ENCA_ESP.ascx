<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_ENCA_ESP.ascx.cs" Inherits="ADMINPT.controles.movimiento_esp.UcListaENTRADA_SALIDA_ENCA_ESP" %>
...
<asp:ObjectDataSource ID="odsLista" runat="server" SelectMethod="ObtenerListaEspecial"  TypeName="ADMINPT.BL.CENTRADA_SALIDA_ENCA">    
