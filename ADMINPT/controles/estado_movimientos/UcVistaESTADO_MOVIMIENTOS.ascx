<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaESTADO_MOVIMIENTOS.ascx.cs" Inherits="ADMINPT.controles.estado_movimientos.UcVistaESTADO_MOVIMIENTOS" %>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer runat="server">
                            ...
                            <tr>
                                ...
                                <td class="filaVista" >
                                    <dx:ASPxTextBox ID="txtNOMBRE_ESTADO" runat="server" Width="400px" >
                                        <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
