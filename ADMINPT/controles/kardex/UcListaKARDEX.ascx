<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaKARDEX.ascx.cs" Inherits="ADMINPT.controles.kardex.UcListaKARDEX" %>
...
<dx:ASPxGridView ID="gridLista" runat="server" Theme="Moderno" KeyFieldName="ID_KARDEX" Width="100%" OnInit="gridLista_Init" OnRowCommand="gridLista_RowCommand" OnCustomUnboundColumnData="gridLista_CustomUnboundColumnData" Font-Size="X-Small">
    <SettingsPager>
  ...
  <Toolbars>
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn Visible="true" Caption="Editar" Name="Editar" CellStyle-HorizontalAlign="Center" Width="20px" VisibleIndex="1">
            <DataItemTemplate>
                <asp:ImageButton ID="lbtnEditar" runat="server" CommandName="Editar" ImageUrl="~/imagenes/Editar.png" CommandArgument='<%# Bind("ID_KARDEX") %>'></asp:ImageButton>
            </DataItemTemplate>
        </dx:GridViewDataTextColumn>

        <dx:GridViewBandColumn Caption="GENERALES" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
            <Columns>
        <dx:GridViewDataTextColumn FieldName="ID_KARDEX" ReadOnly="True" VisibleIndex="2" Width="20px" Caption="Identificador" Visible="true" />

        <dx:GridViewDataTextColumn FieldName="ID_ZAFRA_PROD" VisibleIndex="3" Caption="IdZafra" Visible="false" />
        <dx:GridViewDataTextColumn FieldName="NOMBRE_ZAFRA" VisibleIndex="4" Caption="Zafra" UnboundType="String" />


        <dx:GridViewDataTextColumn FieldName="ID_BODEGAK" VisibleIndex="5" Caption="IdBodega" Visible="false" />
        ...
        <dx:GridViewDataTextColumn FieldName="ID_ESPECI" VisibleIndex="9" Caption="IdBodega" Visible="false" />
        <dx:GridViewDataTextColumn FieldName="NOMBRE_ESPECI" VisibleIndex="10" Caption="Espec Mov" UnboundType="String" />

        <dx:GridViewDataTextColumn FieldName="FECHA" VisibleIndex="11" Caption="Fecha" PropertiesTextEdit-DisplayFormatString="dd/MM/yyyy" />
        <dx:GridViewDataTextColumn FieldName="CANTIDAD" VisibleIndex="12" Caption="Cantidad" />
        <dx:GridViewDataTextColumn FieldName="FACTOR_QQ" VisibleIndex="13" Caption="Factor QQ" Visible="false" />
        <dx:GridViewDataTextColumn FieldName="FACTOR_KG" VisibleIndex="14" Caption="Factor KG" Visible="false" />
        <dx:GridViewDataTextColumn FieldName="SDOINI_QQ" VisibleIndex="15" Caption="SDO Inicial QQ" Visible="false" PropertiesTextEdit-DisplayFormatString="N2" />
        <dx:GridViewDataTextColumn FieldName="SDOINI_KG" VisibleIndex="16" Caption="SDO Inicial KG" Visible="false" PropertiesTextEdit-DisplayFormatString="N2" />
                    </Columns>
...
<asp:ObjectDataSource ID="odsLista" runat="server" SelectMethod="ObtenerLista" TypeName="ADMINPT.BL.CKARDEX"></asp:ObjectDataSource>
