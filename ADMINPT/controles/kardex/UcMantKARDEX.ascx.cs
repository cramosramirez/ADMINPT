...
{
    public partial class UcMantKARDEX : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            UCBarraNavegacion.ReporteConta_Click += _btn_reporteConta_Click;
        ...
        private void InicializarLista()
        {
            ...
            UcListaKARDEX.Visible = true;
            UcVistaKARDEX.Visible = false;
            UcListaKARDEX.CargarDatos();
        }
        ...
        private void InicializarDetalle(Boolean EsEdicion)
        {
            ...
            UcVistaKARDEX.Visible = true;
            UcListaKARDEX.Visible = false;
        }
        ...
        protected void UCBarraOpciones_OpcionSeleccionada(string x)
        {
            ...
            //if (x == "Guardar")
            //{
            //    string Ret = UcVistaKARDEX.Actualizar();
            //    if (Ret == string.Empty)
            //    {
            //        InicializarLista();
            //    }
            ...
            //if (x == "Eliminar")
            //{
            //    string Ret = UcVistaKARDEX.Eliminar();
            //    if (Ret == string.Empty)
            //    {
            //        InicializarLista();
            //    }
        ...
        protected void UcListaKARDEX_Editando(int Identificador)
        {
            InicializarDetalle(true);
            UcVistaKARDEX.Identificador = Identificador;

        }
        protected void _btn_guardar_Click(object sender, EventArgs e)
        {
            //string Ret = UcVistaKARDEX.ActualizarVtaDizucar();
        ...
        protected void _btn_reporte_Click(object sender, EventArgs e)
        {
            ...
            if (HostName == "PORTAL")
            {
                string _open = "window.open('/ADMINPT/forms/wfREPORTE.aspx?mv='+'" + mv + "&id=" + Convert.ToString(UcVistaKARDEX.txt_Identificador.Text) + "&rpt=" + TipoRpt + "', '_newtab');";
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), _open, true);
            }
            else if (HostName == "SV1-IT03")
            {
                string _open = "window.open('/forms/wfREPORTE.aspx?mv='+'" + mv + "&id=" + Convert.ToString(UcVistaKARDEX.txt_Identificador.Text) + "&rpt=" + TipoRpt + "', '_newtab');";
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), _open, true);
            }
