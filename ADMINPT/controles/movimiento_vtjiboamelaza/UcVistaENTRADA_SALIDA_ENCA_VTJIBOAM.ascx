<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaENTRADA_SALIDA_ENCA_VTJIBOAM.ascx.cs" Inherits="ADMINPT.controles.movimiento_vtjiboamelaza.UcVistaENTRADA_SALIDA_ENCA_VTJIBOAM" %>
...
<CaptionStyle Font-Bold="True"></CaptionStyle>
                ...
                <dx:LayoutItem Caption="Producto" ColumnSpan="3" Width="100%" CaptionStyle-Font-Bold="true">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxComboBox ID="cbxProducto"  Font-Bold ="true"   runat="server" TextField="NOMBRE_KARDEX" ValueField="ID_PRODUCTO" ValueType="System.Int32" AutoPostBack="true" OnTextChanged="cbxProducto_TextChanged" Width="100%" ClientEnabled="true">
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
...
<CaptionStyle Font-Bold="True"></CaptionStyle>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxSpinEdit ID="speCantidad" ClientInstanceName="speCantidad" runat="server" Number="" DecimalPlaces="2" ReadOnly="false" HorizontalAlign="Right" OnValueChanged="speCantidad_ValueChanged" AutoPostBack="true" ClientEnabled="true"  DisplayFormatString="N2">
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                <ValidationSettings Display="Dynamic">
                                   <RequiredField IsRequired="True" ErrorText="Requerido !!!" />
                                </ValidationSettings>
        ...
        <dx:LayoutGroup Caption="Información Cliente" ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <table>
                                <tr>
                                    <td>
                                        <dx:ASPxTextBox ID="txtNrc" runat="server"  >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black">
                                </DisabledStyle>                                
                            </dx:ASPxTextBox>
                                    </td>
                                    <td>
                                         <dx:ASPxButton ID="btnrc" runat="server" Text="Nrc" CausesValidation="False" UseSubmitBehavior="false" OnClick="btnrc_Click" >
                                <Image IconID="find_find_svg_16x16">
                                </Image>
                            </dx:ASPxButton>
                                    </td>
                                </tr>
                ...
                <dx:LayoutItem Caption="Departamento">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxTextBox ID="txtDepartamento" runat="server" >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black">
                                </DisabledStyle>
                                 <ClientSideEvents ValueChanged="changedupper" />
                                <ValidationSettings Display="Dynamic">
                ...
                <dx:LayoutItem Caption="Municipio">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxTextBox ID="txtMunicipio" runat="server" >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black">
                                </DisabledStyle>
                                 <ClientSideEvents ValueChanged="changedupper" />
                                <ValidationSettings Display="Dynamic">
                        ...
                        <dx:LayoutItemNestedControlContainer>
                            <table>
                                ...
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black">
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="btdui" runat="server" Text="Dui" CausesValidation="False" UseSubmitBehavior="false" OnClick="btdui_Click" >
                                 <Image IconID="find_find_svg_16x16">
                                </Image>
                            </dx:ASPxButton>
                                    </td>
                ...
                <dx:LayoutItem Caption="Giro" ColumnSpan="3">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxTextBox ID="txtGiro" runat="server" >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black">
                                </DisabledStyle>
                                 <ClientSideEvents ValueChanged="changedupper" />
                ...
                <dx:LayoutItem Caption="Dirección" ColumnSpan="3">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxTextBox ID="txtDireccion" runat="server" >
                                <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black">
                                </DisabledStyle>
                                 <ClientSideEvents ValueChanged="changedupper" />
                                <ValidationSettings Display="Dynamic">
        ...
        <dx:LayoutGroup Caption="Lista de Productos" ClientVisible="false"  ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                ...
                <dx:LayoutItem Caption="" ShowCaption="False" ColumnSpan="3">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <uc1:UcListaENTRADA_SALIDA_DETA_VTJIBOAM runat="server" id="UcListaENTRADA_SALIDA_DETA_VTJIBOAM" />
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
                </dx:LayoutItem>
            </Items>
...
<asp:ObjectDataSource ID="odsORDEN_GLOBAL_TRAS" runat="server" SelectMethod="ObtenerListaCb" TypeName="ADMINPT.BL.CORDEN_GLOBAL_TRAS">
     <SelectParameters>
...
<asp:ObjectDataSource ID="odsBodegaDUser" runat="server" SelectMethod="ObtenerListaBodegaDestino" TypeName="ADMINPT.BL.CBODEGA">
 ...
 <dx:ASPxLoadingPanel ID="ASPxLoadingPanel1" runat="server" Text="Procesando Datos..." ClientInstanceName="ldnPanel" Theme="MaterialCompact" 
        Modal="True">
    </dx:ASPxLoadingPanel>