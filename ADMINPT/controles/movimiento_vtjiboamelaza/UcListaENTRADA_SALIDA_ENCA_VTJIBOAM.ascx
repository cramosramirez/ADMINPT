<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcListaENTRADA_SALIDA_ENCA_VTJIBOAM.ascx.cs" Inherits="ADMINPT.controles.movimiento_vtjiboamelaza.UcListaENTRADA_SALIDA_ENCA_VTJIBOAM" %>
