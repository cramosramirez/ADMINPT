...
{
    public partial class UcListaEXISTENCIA : System.Web.UI.UserControl
    {
        ...
        protected void gridLista_CustomUnboundColumnData(object sender, DevExpress.Web.ASPxGridViewColumnDataEventArgs e)
        {
            ...
            {
                BODEGA lEntidad = new CBODEGA().ObtenerPorId((int)e.GetListSourceFieldValue("ID_BODEGA"));
                if (lEntidad != null)
            ...
            {
                ZAFRA lEntidad = new CZAFRA().ObtenerPorId((int)e.GetListSourceFieldValue("ID_ZAFRA"));
                if (lEntidad != null)
