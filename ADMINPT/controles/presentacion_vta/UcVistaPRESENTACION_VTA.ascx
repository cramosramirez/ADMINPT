<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaPRESENTACION_VTA.ascx.cs" Inherits="ADMINPT.controles.presentacion_vta.UcVistaPRESENTACION_VTA" %>
...
<dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Theme="Moderno" Width="100%">
    ...
    <Items>
        <dx:LayoutGroup ColCount="5" Caption="Datos de Presentacion de Venta"  Name="lgPresentacion_vta" GroupBoxDecoration="HeadingLine">
            <Items>
                ...
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer runat="server">                        
                        <table class="tablaVista" >
                            <tr>
                                <td class="filaVista" ><dx:ASPxLabel runat="server" ID="lblBodega" Text="Identificador:" ></dx:ASPxLabel></td>
                                <td class="filaVista">
