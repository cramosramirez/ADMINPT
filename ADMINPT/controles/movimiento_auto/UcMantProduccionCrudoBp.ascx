<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcMantProduccionCrudoBp.ascx.cs" Inherits="ADMINPT.controles.movimiento_auto.UcMantProduccionCrudoBp" %>
...
<%--                                        <SelectParameters>
                        ...
                        <dx:LayoutItem Caption="Observacion" ColumnSpan="3" Width="100%" CaptionSettings-HorizontalAlign="Right">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxMemo ID="txt_observacion" runat="server" Height="30px" ForeColor="Red"> 
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    ...
                                    <asp:SqlDataSource ID="sds_ListM" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                        SelectCommand="LIST_REPORTES_BP" SelectCommandType="StoredProcedure">
                                        <%--                                       <SelectParameters>
                                            <asp:SessionParameter Name="ID_EMPRESA" SessionField="ID_EMPRESA" Type="Int32" />
...
<%--    </ContentTemplate>
 ...
 <dx:ASPxLoadingPanel ID="ldnPanel" runat="server" Text="Procesando Datos..." ClientInstanceName="ldnPanel" 
        Modal="True">
    </dx:ASPxLoadingPanel>