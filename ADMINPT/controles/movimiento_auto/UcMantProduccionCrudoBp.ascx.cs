...
namespace ADMINPT.controles.movimiento_auto
{
    ...
    public partial class UcMantProduccionCrudoBp : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            UCEncabezado.Titulo= "Ingreso Producción Azucar Cruda Reporte BP";
            ...
            {
                UCBarraNavegacion.btn_fijarTurno.Visible = true;
        ...
        private void RecuperarReporteBpturno()
        {
            try
            {
                ...
                if (Dt.Rows.Count > 0)
                {
                    ...
                    txt_totalDescargas.Value = row["QUINTALES_DIA_TOTALES"].ToString();
                    txt_totalDescargas.Value = row["KILOGRAMOS_DIA_TOTALES"].ToString();
                    txt_observacion.Text = "PRODUCCION DEL DIA: QUINTALES: " + row["QUINTALES_DIA_TOTALES"].ToString() + " /  " + "KILOGRAMOS: " + row["KILOGRAMOS_DIA_TOTALES"].ToString();
                }
                else
                {
                }
