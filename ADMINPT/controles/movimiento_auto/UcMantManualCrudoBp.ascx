<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcMantManualCrudoBp.ascx.cs" Inherits="ADMINPT.controles.movimiento_auto.UcMantManualCrudoBp" %>
...
<%--                                        <ClearButton DisplayMode="Always"></ClearButton>
                                    ...
                                    <asp:SqlDataSource ID="sdscb_articulo" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                        ...
                                        <SelectParameters>
                                            ...
                                            <asp:Parameter Name="ID_TIPO_BASCULA" DbType="Int32" DefaultValue="4" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
...
<%--                                        <SelectParameters>
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    ...
                                    <asp:SqlDataSource ID="sdscb_TipoBascula" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                        ...
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="4" Type="Int32" Name="ID_TIPO_BASCULA" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        ...
                        <dx:LayoutItem Caption="Factor QQ" CaptionSettings-HorizontalAlign="Right">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxTextBox ID="txt_factorq" Text="46" runat="server" ReadOnly="true"  Enabled="false">
                        ...
                        <dx:LayoutItem Caption="Factor K" CaptionSettings-HorizontalAlign="Right">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxTextBox ID="txt_factork" Text="50" runat="server" ReadOnly="true" Enabled="false">
                                        <ClientSideEvents KeyPress="OnKeyPress" />
                                    </dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        ...
                        <dx:LayoutItem Caption="Descargas" CaptionSettings-HorizontalAlign="Right">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxTextBox ID="txt_totalDescargas" runat="server" Enabled="false" DisplayFormatString="N2" Font-Bold="true" Text="1">
                                        <ClientSideEvents KeyPress="OnKeyPress" />
                                    </dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        ...
                        <dx:LayoutItem Caption="Hora" CaptionSettings-HorizontalAlign="Right">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxTimeEdit ID="DtHora" runat="server" EditFormat="Custom" EditFormatString="hh:mm:ss"></dx:ASPxTimeEdit>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                            <CaptionSettings HorizontalAlign="Right" />
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="Kilogramos" CaptionSettings-HorizontalAlign="Right">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxTextBox ID="txt_kilogramos" runat="server" Enabled="true" DisplayFormatString="N2" Font-Bold="true">
                                        <ClientSideEvents KeyPress="OnKeyPress" />
                                    </dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        ...
                        <dx:LayoutItem Caption="" CaptionSettings-HorizontalAlign="left" ColumnSpan="1" HorizontalAlign="Center">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxButton ID="btn_agregar" runat="server" Text="Agregar" Width="150px" OnClick="btn_agregar_Click" >
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxGridView ID="Dgv_ListM" ClientInstanceName="Dgv_ListM" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn FieldName="Id" Caption="Id" ShowInCustomizationForm="True" VisibleIndex="2" Visible="true" Width="80">
                                                <EditFormSettings Visible="False" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="AcumGeneral" Caption="Acum General" ShowInCustomizationForm="True" VisibleIndex="3" Width="80" Visible="true">
                                                <PropertiesTextEdit DisplayFormatString="n2"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="ConsGeneral" Caption="Cons General" ShowInCustomizationForm="True" VisibleIndex="4" Width="80" Visible="true">
                                                <PropertiesTextEdit DisplayFormatString="n2"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="AcumTurno" Caption="Acum turno" ShowInCustomizationForm="True" VisibleIndex="5" Width="80" Visible="true">
                                                <PropertiesTextEdit DisplayFormatString="n2"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="ConsTurno" Caption="Cons Turno" ShowInCustomizationForm="True" VisibleIndex="6" Width="80" Visible="true">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="Descarga" Caption="Descarga" ShowInCustomizationForm="True" VisibleIndex="7" Width="80" Visible="true">
                                                <PropertiesTextEdit DisplayFormatString="n2"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="DescargaQQ" Caption="DescargaQQ" ShowInCustomizationForm="True" VisibleIndex="7" Width="80" Visible="true">
                                                <PropertiesTextEdit DisplayFormatString="n2"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="ConfDescarga" Caption="Conf Descarga" ShowInCustomizationForm="True" VisibleIndex="8" Width="80" Visible="true">
                                                <PropertiesTextEdit DisplayFormatString="n2"></PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataDateColumn FieldName="Fecha" Caption="Fecha" ShowInCustomizationForm="True" VisibleIndex="9" Width="90"  Visible="true">
                                            </dx:GridViewDataDateColumn>
                                            <dx:GridViewDataTextColumn FieldName="Hora" Caption="Observaciones" ShowInCustomizationForm="True" VisibleIndex="10" Width="80"  Visible="true">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="Bascula" Caption="Bascula" ShowInCustomizationForm="True" VisibleIndex="11" Width="80"  Visible="true">
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                                    ...
                                    <asp:SqlDataSource ID="sds_ListM" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                        SelectCommand="LIST_REPORTES_MANUAL" SelectCommandType="StoredProcedure">
                                        <%--                                       <SelectParameters>
                                            <asp:SessionParameter Name="ID_EMPRESA" SessionField="ID_EMPRESA" Type="Int32" />
