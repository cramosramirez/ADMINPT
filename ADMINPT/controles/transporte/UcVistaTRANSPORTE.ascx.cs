...
{
     public partial class UcVistaTRANSPORTE : System.Web.UI.UserControl
    {
        #region "Propiedades"

        private CTRANSPORTE Controlador = new CTRANSPORTE();
        ...
        private void CargarVista()
        {
            ...
            ModoEdicion(true);
            TRANSPORTE Entidad = Controlador.ObtenerPorId(Identificador);
            if (Entidad != null)
            {
                txtIdentificador.Text = Entidad.ID_TRANSPORTE.ToString();
