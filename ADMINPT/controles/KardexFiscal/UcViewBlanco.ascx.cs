...
{
    public partial class UcViewBlanco : System.Web.UI.UserControl
    {
        private void Inicializar()
        {
            UCEncabezado.Titulo = "KARDEX CONTABLE DE AZUCAR BLANCA SC 50KG";
...
#pragma warning disable CS0246 // El nombre del tipo o del espacio de nombres 'RptBlancoFiscal' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptBlancoFiscal(Convert.ToDateTime(fde), Convert.ToDateTime(fht), Convert.ToInt32(cb_bodegaO.Value),  Convert.ToInt32(1)));
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'RptBlancoFiscal' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
