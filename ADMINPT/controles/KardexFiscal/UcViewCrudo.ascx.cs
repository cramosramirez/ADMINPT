...
namespace ADMINPT.controles.KardexFiscal
{
    public partial class UcViewCrudo : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "KARDEX CONTABLE DE AZUCAR CRUDO A GRANEL";
        ...
        {
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptCrudoFiscal(Convert.ToDateTime(fde), Convert.ToDateTime(fht), Convert.ToInt32(cb_bodegaO.Value),  Convert.ToInt32(2)));
