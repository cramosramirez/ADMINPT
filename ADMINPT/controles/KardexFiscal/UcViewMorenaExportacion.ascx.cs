...
namespace ADMINPT.controles.KardexFiscal
{
    public partial class UcViewMorenaExportacion : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "KARDEX CONTABLE DE AZUCAR MORENA EXPORTACION SC 50KG";
        ...
        {
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMorenoExportacion(Convert.ToDateTime(fde), Convert.ToDateTime(fht), Convert.ToInt32(cb_bodegaO.Value),  Convert.ToInt32(3)));
