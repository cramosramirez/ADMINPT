...
namespace ADMINPT.controles.KardexFiscal
{
    public partial class UcViewBlancoJumbo : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "KARDEX CONTABLE DE AZUCAR BLANCA JUMBO 27.18 QQ";
...
#pragma warning disable CS0246 // El nombre del tipo o del espacio de nombres 'RptBlancoFiscal' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptBlancoJumboFiscal(Convert.ToDateTime(fde), Convert.ToDateTime(fht), Convert.ToInt32(cb_bodegaO.Value),  Convert.ToInt32(8)));
