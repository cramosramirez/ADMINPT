...
namespace ADMINPT.controles.KardexFiscal
{
    public partial class UcViewMelaza : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "KARDEX CONTABLE DE MELAZA A GRANEL";
        ...
        public void llenarReporteNotas(DateTime fde ,DateTime fht)
        {
                ...
                var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMelazaFiscal(Convert.ToDateTime(fde), Convert.ToDateTime(fht), Convert.ToInt32(cb_bodegaO.Value), Convert.ToInt32(5)));
