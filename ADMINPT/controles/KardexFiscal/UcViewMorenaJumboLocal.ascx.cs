...
namespace ADMINPT.controles.KardexFiscal
{
    public partial class UcViewMorenaJumboLocal : System.Web.UI.UserControl
    {
        ...
        {
            UCEncabezado.Titulo = "KARDEX CONTABLE DE AZUCAR MORENA JUMBO LOCAL 27.18 QQ";
        ...
        {
            var cachedReportSourceKardex = new CachedReportSourceWeb(new RptMorenoJumboLocalFiscal(Convert.ToDateTime(fde), Convert.ToDateTime(fht), Convert.ToInt32(cb_bodegaO.Value),  Convert.ToInt32(6)));
