<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVistaPROVEEDOR_TRAS.ascx.cs" Inherits="ADMINPT.controles.proveedor_tras.UcVistaPROVEEDOR_TRAS" %>
...
<dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Theme="Moderno" Width="100%">
    ...
    <Items>
        <dx:LayoutGroup ColCount="5" Caption="Datos de Turno" Name="lgTIPO_REF_TRAS" GroupBoxDecoration="HeadingLine">
            <Items>
                <dx:LayoutItem Caption="" ColSpan="1" Name="">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer runat="server">
                            ...
                            <tr>
                                <td class="filaVista" ><dx:ASPxLabel runat="server" ID="lblTIPO_REF_TRAS" Text="Identificador:" ></dx:ASPxLabel></td>
                                <td class="filaVista">
                            ...
                            <tr>
                                <td class="filaVista"><dx:ASPxLabel runat="server" ID="ASPxLabel2" Text="Transporte:" ></dx:ASPxLabel></td>
                                <td class="filaVista" >
                                    <dx:ASPxTextBox ID="txtTransporte" runat="server" Width="400px" >
                                        <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                        <ValidationSettings Display="Dynamic">
                                            <RequiredField IsRequired="True" ErrorText="Transporte es requerido" />
                                        </ValidationSettings>
                                    </dx:ASPxTextBox>
                                </td>
                            </tr>
