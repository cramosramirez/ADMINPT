...
{
    public partial class UcListaTIPO_PRODUCTO : System.Web.UI.UserControl
    {
        ...
        {
            if (e.Column.FieldName == "FAMILIA")
            {
                FAMILIA lEntidad = new CFAMILIA().ObtenerPorId((int)e.GetListSourceFieldValue("ID_FAMILIA"));
                if (lEntidad != null)
                    e.Value = lEntidad.NOMBRE_FAMILIA;
            }
        }
    }
}