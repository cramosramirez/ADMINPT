<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcVentasIngenios.ascx.cs" Inherits="ADMINPT.AlmapacJiboa.View.UcVentasIngenios" %>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            ...
                            <asp:SqlDataSource ID="SqdListtpdoc" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                SelectCommand="CB_TIPO_DOCTO_VTING" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
          ...
          <dx:LayoutGroup Caption="Información Cliente" ColCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="false" Paddings-PaddingTop="2">
            ...
            <Items>
                <dx:LayoutItem Caption="Bodega Destino" ColumnSpan="2" CaptionStyle-Font-Bold="true" >
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                             <dx:ASPxComboBox ID="cb_cliente" runat="server" TextField="NOMBRE" ValueField="ID_CLIENTEING" ValueType="System.Int32"
                            ...
                            <asp:SqlDataSource ID="SqdListClient" runat="server" ConnectionString="<%$ ConnectionStrings:cn %>"
                                SelectCommand="CB_CLIENTE_INGENIOS" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
                </dx:LayoutItem>                
...
<asp:ObjectDataSource ID="odsZAFRA_ACTUAL" runat="server" SelectMethod="ObtenerListaActivaALMAPAC" TypeName="ADMINPT.BL.CZAFRA"></asp:ObjectDataSource>
...
<asp:ObjectDataSource ID="odsCONCEPTO_MOVI" runat="server" SelectMethod="ObtenerPorIdTMVtIng" TypeName="ADMINPT.BL.CCONCEPTO_MOVI">
    <SelectParameters>
        <asp:Parameter Name="ID_PRODUCTO" DefaultValue="-1" Type="Int32" />
