<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcRptDia.ascx.cs" Inherits="ADMINPT.RptDia.UcRptDia" %>
  ...
  <dx:ASPxFormLayout ID="FtListEmpresa" CssClass="modal-content" runat="server">
            ...
            <Items>
                <dx:LayoutGroup Caption="" ColumnCount="2" ShowCaption="false" GroupBoxDecoration="Box"
                    ...
                    <Items>
                 <dx:LayoutItem Caption="Bodega Origen" ColumnSpan="1" CaptionStyle-Font-Bold="false" ClientVisible="true">
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer>
                            <dx:ASPxCheckBox ID="chk_consolidado" Text="" runat="server" CheckState="Unchecked" Enabled="true"></dx:ASPxCheckBox>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
                    <CaptionSettings HorizontalAlign="Right"></CaptionSettings>
                </dx:LayoutItem>  
                 <dx:LayoutItem Caption="Zafra"  CaptionSettings-HorizontalAlign="Right">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
