...
{
    public partial class Rpt_TrasladoInternoCE5 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rpt_TrasladoInternoCE5(int ID_PRODUCTO, DateTime FECHA, int ID_ZAFRA_PROD)
        {
            InitializeComponent();
