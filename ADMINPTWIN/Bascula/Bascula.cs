...
{
    public partial class Bascula : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public void BascEncDt()
        {
            try
            {
                ...
                else
                {
                    ...
                    Cnn.cn.Open();
                    DataTable Dt;
                    Dt = CDatos._SEL_BASCULA_ENCA_ES(Convert.ToInt32(lbIdentificadorEnc.Text));
                    if (Dt.Rows.Count > 0)
                    {
                        DataRow row = Dt.Rows[0];
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Dt.Rows.Count > 0)
                    {
                        ...
                        txtPesotarima.Text = Convert.ToString(row["PESOTARIMA"].ToString());
        ...
        public void EncDt()
        {
            try
            {
                ...
                else
                {
                    ...
                    Cnn.cn.Open();
                    DataTable Dt;
                    Dt = CDatos._SEL_ENTRADA_SALIDA_ENCA(Convert.ToInt32(lbIdentificadorEnc.Text));
                    if (Dt.Rows.Count > 0)
                    {
                        DataRow row = Dt.Rows[0];
            ...
            {
                Cnn.cn.Close();
                if (Convert.ToInt32(cbEstado.SelectedValue) == 1 || Convert.ToInt32(cbEstado.SelectedValue) == 2 || Convert.ToInt32(cbEstado.SelectedValue) == 4)
                {                    
        ...
        public void DDt()
        {
            try
            {
                ...
                else
                {
                    ...
                    Cnn.cn.Open();
                    DataTable Dt;
                    Dt = CDatos._SEL_ENTRADA_SALIDA_DETA(Convert.ToInt32(lbIdentificadorEnc.Text));
                    if (Dt.Rows.Count > 0)
                    {
                        DataRow row = Dt.Rows[0];
                        txtCantida.Text = Convert.ToString(row["CANTIDAD"].ToString());
...
MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                ...
                else if (Convert.ToString(txtTara.Text) == "0")
                {
...
MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
        ...
        private void InsBascDet(int Id)
        {
            try
            {
                ...
                Cnn.cn.Close();
                Cnn.cn.Open();
                SqlCommand guardar = new SqlCommand("CRE_BASCULA_DETA_ES", Cnn.cn);
                guardar.CommandType = CommandType.StoredProcedure;
        ...
        private void UpdBascDet(int Id, int IdENC)
        {
            try
            {
                ...
                else if ((Convert.ToInt16(cbProducto.SelectedValue) == 2 && Convert.ToInt16(cbConcepto.SelectedValue) == 12) || (Convert.ToInt16(cbProducto.SelectedValue) == 5 && Convert.ToInt16(cbConcepto.SelectedValue)==12))
                {
                    if (Convert.ToString(txtMarchamos.Text) == "")
                    { MessageBox.Show("Marchamos Requerido", "Mensaje", MessageBoxButtons.OK,  MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);  }
                    ...
                    else
                    {
                        ...
                        Cnn.cn.Close();
                        Cnn.cn.Open();
                        SqlCommand guardar = new SqlCommand("UPD_BASCULA_DETA_ES", Cnn.cn);
                        guardar.CommandType = CommandType.StoredProcedure;
                        guardar.Parameters.AddWithValue("@TPCAP", Convert.ToString(cbTipoCaptura.Text));
                ...
                else
                {
                    ...
                    if (Convert.ToString(cbTipoCaptura.Text) == "Tara")
                    {
                        ...
                        else if ((Convert.ToString(txtBruto.Text) != "0") || (Convert.ToString(txtBruto.Text) != "0.00"))
                        {
                            ...
                            pesoflen = pesof.Length;
                            pesof2 = pesof.Substring(0, (pesoflen - 2));
                            txtTara.Text = Convert.ToString(Convert.ToDecimal(pesof2));
                            txtNeto.Text = Convert.ToString(decimal.Round(Convert.ToDecimal(txtBruto.Text) - (Convert.ToDecimal(txtTara.Text) + Convert.ToDecimal(txtPesotarima.Text)), 2));
        ...
        public void RptPesos(int ID_BASCULAENCA)
        {
            try
            {
                if (Convert.ToString(cbTipoCaptura.Text) == "Tara")
                {
                    Reportes.Bascula.Rpt_PesosTara ReportT = new Reportes.Bascula.Rpt_PesosTara(ID_BASCULAENCA);
                ...
                {
                    Reportes.Bascula.Rpt_PesosBruto ReportB = new Reportes.Bascula.Rpt_PesosBruto(ID_BASCULAENCA);
                    Reportes.Visor form = new Reportes.Visor();
        ...
        public void RptPesosall(int ID_BASCULAENCA)
        {
            try
            {
                Reportes.Bascula.Rpt_Pesos Report = new Reportes.Bascula.Rpt_Pesos(ID_BASCULAENCA);
                Reportes.Visor form = new Reportes.Visor();
        ...
        {
            if (Convert.ToString(txtIdentificador.Text) != "0" && ck_imptd.Checked == false)
            { RptPesosall(Convert.ToInt32(txtIdentificador.Text)); }
            else
            {
                MessageBox.Show("NO SE PUEDE REIMPRIMIR LOS PESOS PARA ESTE DOCUMENTO " + txtNdocumento.Text, "Mensaje", MessageBoxButtons.OK,
               MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        }
        ...
        private void btImprimirTara_Click(object sender, EventArgs e)
        {
            ...
            {
                Reportes.Bascula.Rpt_PesosTara ReportT = new Reportes.Bascula.Rpt_PesosTara(Convert.ToInt32(txtIdentificador.Text));
            Reportes.Visor form = new Reportes.Visor();
            form._view_documento.DocumentSource = ReportT;
            form.Show();
                btNuevo_Click(null, null);
