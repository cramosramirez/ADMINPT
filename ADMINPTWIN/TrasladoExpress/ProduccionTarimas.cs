...
{
    public partial class ProduccionTarimas : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        private delegate void DelegadoAcceso(string accion);
        string cbTipoCaptura = "Bruto";
        public ProduccionTarimas()
        {
            InitializeComponent();
       ...
       //MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
        ...
        public void Dt()
        {
            try
            {
                    ...
                    Cnn.cn.Open();
                    DataTable Dt;
                    Dt = CDatos._VIEW_MOVIMIENTOS_WINDOWS(Convert.ToInt32(1));
                    if (Dt.Rows.Count > 0)
                    {
                        DataRow row = Dt.Rows[0];
        ...
        private void ProduccionTarimas_Load(object sender, EventArgs e)
        {
