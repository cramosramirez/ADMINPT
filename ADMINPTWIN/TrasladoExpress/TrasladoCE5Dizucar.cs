...
{
    public partial class TrasladoCE5Dizucar : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        private delegate void DelegadoAcceso(string accion);
        string cbTipoCaptura = "Bruto";
        public TrasladoCE5Dizucar()
        {
            InitializeComponent();
        ...
        public void Dt()
        {
            try
            {
                ...
                Cnn.cn.Open();
                DataTable Dt;
                Dt = CDatos._VIEW_MOVIMIENTOS_WINDOWS(Convert.ToInt32(3));
                if (Dt.Rows.Count > 0)
                {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Dt.Rows.Count > 0)
                    {
                        ...
                        txtCantida.Text = Convert.ToString(row["SACOSCE5"].ToString());
        ...
        private void InsEnc()
        {
            ...
            try
            {
                ...
                Cnn.cn.Close();
                Cnn.cn.Open();
                SqlCommand guardar = new SqlCommand("CRE_ENTRADA_SALIDA_ENCA_TRASLADO_CE5", Cnn.cn);
        ...
        private void InsEncDet(int Id)
        {
            try
            {
                ...
                Cnn.cn.Close();
                Cnn.cn.Open();
                SqlCommand guardar = new SqlCommand("CRE_ENTRADA_SALIDA_DETA_TRASLADO_CE5", Cnn.cn);
                guardar.CommandType = CommandType.StoredProcedure;   
        ...
        private void InsBascEnc()
        {
            ...
            try
            {
                ...
                Cnn.cn.Close();
                Cnn.cn.Open();
                SqlCommand guardar = new SqlCommand("CRE_BASCULA_ENCA_ES_CE5", Cnn.cn);
                guardar.CommandType = CommandType.StoredProcedure;
        ...
        private void InsBascDet(int Id)
        {
            try
            {
                ...
                Cnn.cn.Close();
                Cnn.cn.Open();
                SqlCommand guardar = new SqlCommand("CRE_BASCULA_DETA_ESWIN_CE5", Cnn.cn);
                guardar.CommandType = CommandType.StoredProcedure;
        ...
        private void TrasladoCE5Dizucar_Load(object sender, EventArgs e)
        {
        ...
        private void txtCodbarra_TextChanged(object sender, EventArgs e)
        {
           ...
           // BascEncDt();
            ...
            {
                txtCodTarima.Text = "31";
                txtCodTarima_EditValueChanged(null, null);
            }
            else { txtCodTarima.Text = string.Empty;
        ...
        private void btGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                { MessageBox.Show("Horario Requerido !!!", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Error); }
                else if (Convert.ToString(txtBruto.Text) == "0")
                { MessageBox.Show("BRUTO NO PUEDE CERO !!!", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Error); }
                else
        ...
        private void btNuevo_Click(object sender, EventArgs e)
        {
           ...
           //txtFecha.DateTime = DateTime.Now;
            ...
            cbBodegaOrigen.SelectedIndex = -1;
            cbBodegaDestino.SelectedIndex = -1;
            txtCodTarima.Text = string.Empty;
            txtCantida.Text = "0";
            txtLectura.Text = "0";
            txtPeso.Text = "0";
            txtPTarima.Text = "0";
