...
{
    public partial class TrasladoInterno : DevExpress.XtraBars.Ribbon.RibbonForm
    {
       ...
       //             MessageBox.Show("S COM", "Mensaje", MessageBoxButtons.OK,
       //MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
        ...
        public void Dt()
        {
            try
            {
                ...
                Cnn.cn.Open();
                DataTable Dt;
                Dt = CDatos._VIEW_MOVIMIENTOS_WINDOWS(Convert.ToInt32(4));
                if (Dt.Rows.Count > 0)
                {
                    DataRow row = Dt.Rows[0];
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Dt.Rows.Count > 0)
                    {
                       ...
                       //txtFecha.DateTime = DateTime.Now;
                        if((Convert.ToInt32(row["ID_PRODUCTO"].ToString()))== 6 || (Convert.ToInt32(row["ID_PRODUCTO"].ToString())) == 7 || (Convert.ToInt32(row["ID_PRODUCTO"].ToString())) == 8)
        ...
        private void TrasladoInterno_Load(object sender, EventArgs e)
        {
